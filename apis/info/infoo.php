...
$soportecURL = "S";
//$url         = urlServicios."consultadetalle/consultadetalle_info.php?IdUsuario=".$_SESSION['IdUsuario'];
$url         = urlServicios."consultadetalle/consultadetalle_info.php?IdUsuario=". $id ."&tu=". $tu."&em=".$em;
$existe      = "";
$usulocal    = "";
$siguex      = "";
...
echo $mproceso['pro_proceso']['MisProcesos'];
?>