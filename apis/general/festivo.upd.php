...
if(function_exists('curl_init')) // Comprobamos si hay soporte para cURL
{
	$existeReg = "N";	
	$tabla = 'festivo';	
	//include("/../revisaExiste.php") ;
	include $_SERVER['DOCUMENT_ROOT']."/$dominio/apis/revisaExiste.php" ;
	
	if($existeReg == "S")
	{		
		
		$parameters = "update=update&nombre=$nombre&vanciaJudicial=$vanciaJudicial&estado=$estado&idtabla=$idtabla";
		$soportecURL = "S";
		...
		if(function_exists('curl_init')) // Comprobamos si hay soporte para cURL
		{
			...
			//echo("<script>console.log('PHP: ".print_r($mfestivo)."');</script>");
