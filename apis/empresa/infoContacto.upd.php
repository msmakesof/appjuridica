...
$parameters = "update=update&tipodocumento=$tipodocumento&numerodocumento=$numerodocumento&nombre1=$nombre&nombre2=$nombre2&apellido1=$apellido1&apellido2=$apellido2&email=$email&celular=$celular&fijo=$fijo&estado=$estado&ciudad=$ciudad&usuarioModifica=$usuarioModifica&idtabla=$idtabla";
$soportecURL = "S";
$url         = urlServicios."consultadetalle/consultadetalle_ContactoEmpresa.php?".$parameters;
$existe      = "";
$usulocal    = "";
$siguex      = "";
//echo("<script>console.log('PHP updContactoEmpresa: ".$url."');</script>");
