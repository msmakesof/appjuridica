...
$url         = urlServicios."consultadetalle/cd_tapxorigen.php?".$params;
//echo "<script>console.log('PHP tapxorigen: ".$url."');</script>";
if(function_exists('curl_init')) // Comprobamos si hay soporte para cURL
{
    ...
    //echo "<script>console.log('PHP: ".count($mjuzgado['pro_actuacionprocesal'])."');</script>";
