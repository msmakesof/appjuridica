...
if(function_exists('curl_init')) // Comprobamos si hay soporte para cURL
{
	...
	if($existeReg == "S")
	{
		...
		$parameters = "update=update&Ubicacion=$ubicacion&Ciudad=$ciudad&Direccion=$direccion&Telefono=$telefono&Piso=$piso&TipoJuzgado=$tipojuzgado&Area=$area&Estado=$estado&Edificio=$edificio&Email=$email&idtabla=$idtabla";
		$soportecURL = "S";
		$url         = urlServicios."consultadetalle/consultadetalle_juzgado.php?".$parameters;
		$existe      = "";
		$usulocal    = "";
		$sigue      = "";
		//echo("<script>console.log('PHP upd Juzgado: ".$url."');</script>");
		if(function_exists('curl_init')) // Comprobamos si hay soporte para cURL
		{
			$ch = curl_init();
