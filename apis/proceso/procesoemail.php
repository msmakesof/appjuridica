...
$params ="EmailProceso=EmailProceso&Proceso=$pproceso";
$soportecURL = "S";
$url         = urlServicios."consultadetalle/consultadetalle_pro_proceso.php?".$params;
$existe      = "";
$usulocal    = "";
$siguex      = "";
//echo("<script>console.log('PHP proceso mail: ".$url."');</script>");
if(function_exists('curl_init')) // Comprobamos si hay soporte para cURL
{
	...
	//echo("<script>console.log('PHP email abogado: $emailAbogado');</script>");
