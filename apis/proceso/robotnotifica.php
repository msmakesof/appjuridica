...
if(!isset($diascalcula))
{
	$diascalcula = 0;
}
$params = "IdMostrar=0&u=$pusuario&t=$ptipousuario&e=$empresa&dc=$diascalcula";
$soportecURL = "S";
$url         = urlServicios."consultadetalle/robotnotifica.php?".$params;
//echo("<script>console.log('PHP robot: ".$url."');</script>");
