...
$parameters = "update=update&observacion=$observacion&actpro=$actpro&fechainicio=$fechainicio&fechaestado=$fechaestado&idtabla=$idtabla";
$soportecURL = "S";
...
if(function_exists('curl_init')) // Comprobamos si hay soporte para cURL
{
    ...
    //echo("<script>console.log('PHP: ".count($m['pro_actuacionprocesal'])."');</script>");
