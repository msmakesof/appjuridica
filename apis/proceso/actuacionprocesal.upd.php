...
if(function_exists('curl_init')) // Comprobamos si hay soporte para cURL
{
  $existeReg = "N";	
    ...
    $parameters = "update=update&fechainicio=$fechainicio&origen=$origen&actpro=$actpro&fechaestado=$fechaestado&observacion=$observacion&gasto=$gasto&idtabla=$idtabla";
    $soportecURL = "S";
