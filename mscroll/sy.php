...
<html>
  <head>
    ...
    <title>SX News</title>
    <!-- Bootstrap core CSS -->
    <!--    <link href="../../mscroll/assets/css/bootstrap.css" rel="stylesheet">
	<!-- Custom styles for this template 
	<link href="../../mscroll/assets/css/main.css" rel="stylesheet"> -->
    
    <!--   ../../mscroll/  
    <link href="../../mscroll/assets/css/font-awesome.min.css" rel="stylesheet"> -->
    <!-- <link href="../../mscroll/assets/css/prism.css" rel="stylesheet" /> -->
    <link href="../../mscroll/assets/css/jquery.mCustomScrollbar.css" rel="stylesheet" type="text/css" />
  ...
  <body>	
    ...
    <script src="../../mscroll/assets/js/bootstrap.js"></script>
    <script src="../../mscroll/assets/js/prism.js"></script> --> 
	
    <script src="../../mscroll/assets/js/jquery.mCustomScrollbar.min.js"></script>
    <script src="../../mscroll/assets/js/jquery.newsTicker.js"></script>
    <script>
	/*
	...
	*/
		...
		$(document).ready(function () {		
			...
			function noticias() {
				$.post( "../../mscroll/y.php", function( data ) {
					console.log(data);
					$( "#mks" ).html( data );
				});
			}
			...
			function xnoticias() {
				//alert(7);
				$.ajax({
					url : "../../mscroll/listaNoticias.php",		//../../mscroll/
					type: "POST",
					dataType : 'json',
					/*
					beforeSend: function() {
