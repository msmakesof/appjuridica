    ...
    <div class="container" style="margin-top:-5px;">
        ...
        <form action="" method="post">
            ...
            <option value="">Seleccione Profesor</option>
                ...
                ?>
                <option value="<?php echo $idTablap ;?>" <?php if($idTablap == $sede) {echo "selected";} else{ echo "";} ?>><?php echo $NombreProfesor ;?></option>
                <?php 
            ...
            <hr>
            <button type="button" class="btn btn-danger" name="tomar" id="tomar">Tomar Clase</button>
			<br>
