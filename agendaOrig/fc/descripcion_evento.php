...
<form action="" method="post">
	...
	<?php if( $hoy > $final ) 
	{
		echo '<button type="submit" class="btn btn-info" name="eliminar_evento">Cerrada</button>';
	}
	else
	{
		echo '<button type="submit" class="btn btn-danger" name="eliminar_evento">Eliminar</button>';	
	}
	?>
</form>
</html>