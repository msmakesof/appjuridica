    ...
    <nav class="navbar">
        <div class="container-fluid">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="../../index.html"><img src="../../images/logotxt.gif"></a>
            </div>
                ...
                <div class="info-container">
                    ...
                    <div class="btn-group user-helper-dropdown">
                        ...
                        <ul class="dropdown-menu pull-right">
                            ...
                            <li><a href="javascript:void(0);"><i class="material-icons">favorite</i>Notificaciones</a></li>
                            <li role="seperator" class="divider"></li>
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                ...
                                <ul class="ml-menu">                                     
                                    <li>
                                        <a href="file:///D|/xampp/pages/widgets/cards/no-header.html">Alarmas</a>
                                    </li>
                                    <li>
                                        <a href="file:///D|/xampp/pages/widgets/cards/no-header.html">Controles</a>
                                    </li>                                    
                                </ul>
                                <a href="javascript:void(0);" class="menu-toggle">
                                ...
                                <ul class="ml-menu">              
                                    <li>
                                        <a href="file:///D|/xampp/pages/widgets/cards/colored.html"> Envío de correos</a>
                                    </li>
                                </ul>
