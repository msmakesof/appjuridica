<?php require_once('../../hash/config2.php'); ?>
<!DOCTYPE html>
<html>
        ...
        <div class="card">
            <div class="body">
                <form id="sign_in" method="POST">
                    <div class="msg">Bienvenido, favor iniciar su sesión</div>
     	...
     	$("#ingresar").click( function()             
		{
            ...
            {    
				...
				.done(function( dataX, textStatus, jqXHR ){					
					...
					if( respstr == "M" )
                    {
                        //relocate("../tables/datos.php",{"ƒ×":usuario, "ƒ¤":""});
                        window.location.href="../tables/datos.php";
                    }			      	
				})
