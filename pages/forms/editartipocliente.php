...
$Nombre = trim($mtipocliente['cli_tipocliente']['TCL_Nombre']);
$estado = $mtipocliente['cli_tipocliente']['TCL_Estado'];
$idtabla = $mtipocliente['cli_tipocliente']['TCL_IdTipoCliente'];
        ...
        alertify.confirm( 'Desea borrar este registro?', function (e) {
            if (e) {
                ...
                $.ajax({
                    ...
                    type: "POST",
                    dataType: "html",
                    url : "../forms/borrar_tipocliente.php",
                })  
                .done(function( dataX, textStatus, jqXHR ){                       
                    var xrespstr = dataX.trim();
                    var respstr = xrespstr.substr(0,1);
