   ...
   <!--  <script src="../../plugins/sweetalert/sweetalert.min.js"></script> -->
    ...
    {           
        ...
        {             
            ...
            if( tipodocumento == "" || numerodocumento =="" || nombre == "" || apellido1 == "" || clave =="" || IdCargoFuncionario == "" || email == "" || IdIpsFuncionario == "" || estado == undefined || centroacopio == "")
            {               
                swal({
            ...
            {
                $.ajax({
                    data : {"tipodocumento": tipodocumento, "numerodocumento": numerodocumento, "nombre": nombre, "apellido1": apellido1, "clave": clave, "IdCargoFuncionario": IdCargoFuncionario, "email": email, "IdIpsFuncionario": IdIpsFuncionario, "estado": estado, "centroacopio": centroacopio}, 
                    type: "POST",
                    dataType: "html",
                    url : "crea_funcionario.php",
                })  
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                               ...
                               <!--  </div>
                                ...
                                <div class="form-group form-float">
                                    <label class="form-label">IdCargoFuncionario</label>
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="IdCargoFuncionario" id="IdCargoFuncionario" value="" maxlength="50" required>
                                       <!-- -->
                                    </div>
                                </div>
                                <div class="form-group form-float">
                                ...
                                <div class="form-group form-float">
                                     <label class="form-label">IdIpsFuncionario</label>
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="IdIpsFuncionario" id="IdIpsFuncionario" value="" maxlength="13" required>
                                       <!---->
                                    </div>
                                </div>                               
