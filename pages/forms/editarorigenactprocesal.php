...
$Nombre = trim($morigenactprocesal['pro_origenactprocesal']['OAP_Nombre']);
$estado = $morigenactprocesal['pro_origenactprocesal']['OAP_Estado'];
$idtabla = $morigenactprocesal['pro_origenactprocesal']['OAP_IdOrigen'];
?>
<!DOCTYPE html>
<html>
