...
$query_rs_base = "SELECT IdCentroAcopio FROM centrosacopio WHERE NombreCentroAcopio = '$nombre' ;" ;
...
{ 
	$idciudad = $strowreg["IdCentroAcopio"];	
}
...
{
  $insertSQL = "INSERT INTO centrosacopio (NombreCentroAcopio, Estado) VALUES ('$nombre', '$estado');";
  mysqli_select_db($cnn_kn, $database_cnn_kn);
