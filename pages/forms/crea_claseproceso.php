...
if(function_exists('curl_init')) // Comprobamos si hay soporte para cURL
{
  ...
  {          
    ...
    //print_r ($m);
    $existe = $m['pro_claseproceso']['existe'];
    if($existe > 0)
    {
      $sigue = "E-Existe una Clase de Proceso registrado con el mismo Nombre.";
    }
    else
    {
      
      $parameters = "insert=insert&Nombre=$pnombre&Dias=$pdias&Estado=$pestado";
      $soportecURL = "S";
      $url         = urlServicios."consultadetalle/consultadetalle_pro_claseproceso.php?".$parameters;
      $existe      = "";
      $usulocal    = "";
