...
$query_rs_base = "SELECT IdHorario FROM horario WHERE Inicio = '$nombre' AND Final = '$final';" ;
...
else
{
	...
	$insertSQL = "INSERT INTO horario (Inicio, Final, Estado) VALUES ('$nombre', '$final', $estado);";
