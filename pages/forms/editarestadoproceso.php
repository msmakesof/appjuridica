...
require_once('../../apis/proceso/estadoproceso.php');
$Nombre = trim($mestadoproceso['pro_estadoproceso']['EPR_Nombre']);
$estado = $mestadoproceso['pro_estadoproceso']['EPR_Estado'];
$idtabla = $mestadoproceso['pro_estadoproceso']['EPR_IdEstado'];
?>
<!DOCTYPE html>
<html>
