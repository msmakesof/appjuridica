...
//echo $idTabla."<br>";
$Tabla ="SUBCLASEPROCESO";
$idtabla = 0;

require_once('../../apis/proceso/subclaseproceso.php');
$Nombre = trim($msubclaseproceso['pro_subclaseproceso']['SCP_Nombre']);
$ClaseProceso = $msubclaseproceso['pro_subclaseproceso']['SCP_IdClaseProceso'];
$estado = $msubclaseproceso['pro_subclaseproceso']['SCP_Estado'];
$idtabla = $msubclaseproceso['pro_subclaseproceso']['SCP_IdSubClaseProceso'];
?>
<!DOCTYPE html>
<html>
...
<body class="theme-indigo">
                                ...
                                <div style="form-group form-float">                                     
                                    ...
                                    <div class="col-sm-4">                                       
                                        <select class="selectpicker show-tick" data-live-search="true" data-width="90%" name="claseproceso" id="claseproceso" required>
                                            ...
                                            ?>
                                                    <option value="<?php echo $CPR_IdClaseProceso; ?>" <?php if ($CPR_IdClaseProceso == $ClaseProceso){ echo "selected";} else{ echo "";} ?>>
                                                        <?php echo $CPR_Nombre ; ?>                                                
                                                    </option>
                                            <?php
                                                }
	...
	{			
		...
		$("#grabar").on('click', function(e) {
			...
			$.ajax({
				data : {"nombre": nombre, "claseproceso": claseproceso, "estado": estado, "idtabla": idtabla},
				type: "POST",
				dataType: "html",
