...
$query_rs_base = "SELECT IdRol FROM gen_roles WHERE NombreRol = '$nombre' ;" ;
...
{
  $insertSQL = "INSERT INTO gen_roles (NombreRol, EstadoRol) VALUES ('$nombre', '$estado');";
  mysqli_select_db($cnn_kn, $database_cnn_kn);
