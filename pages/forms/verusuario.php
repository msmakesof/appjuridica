...
{
	$idresponsable = trim($_POST['idtabla']);
}
require_once('../../Connections/DataConex.php');
$params = "IdResponsableProceso=$idresponsable";
$soportecURL = "S";
$url         = urlServicios."consultadetalle/consultadetalle_pro_proceso.php?".$params;
$existe      = 0;
$usulocal    = "";
$siguex      = "";
//echo("<script>console.log('PHP TotalProcesos: ".$url."');</script>");
if(function_exists('curl_init')) // Comprobamos si hay soporte para cURL
{
	...
	$existe    = $mproceso['pro_proceso'][0]['totalProcesos'];
}
else
{
    $soportecURL = "N";
...
{
	echo trim($mproceso['pro_proceso'][0]['totalProcesos']) ; 
}
else
{
