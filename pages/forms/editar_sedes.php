...
$query_rs_tabla = "SELECT IdSucursal FROM sucursal WHERE IdSucursal = $idSucursal; "; 
...
if( $totalRows_rs_tabla == 1 )
{
	...
	$insertSQL = "UPDATE sucursal SET NombreSucursal = '$nombre', EstadoSucursal = $estado, DireccionSucursal ='$direccion', EmailSucursal = '$email',  TelefonoSucursal ='$telefonofijo', EstadoSucursal = $estado WHERE IdSucursal = $idSucursal;";
	 mysqli_select_db($cnn_kn, $database_cnn_kn);
