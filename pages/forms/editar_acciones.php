...
$query_rs_tabla = "SELECT IdAccion FROM gen_acciones WHERE IdAccion = $idEstudiante; "; 
...
{
	$insertSQL = "UPDATE gen_acciones SET NombreAccion = '$nombre', EstadoAccion = $estado WHERE IdAccion = $idEstudiante;";
	 mysqli_select_db($cnn_kn, $database_cnn_kn);
