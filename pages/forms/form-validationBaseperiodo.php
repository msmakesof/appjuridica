...
<head>
    ...
    {       
        ...
        $("#grabar").on('click', function(e) {             
            ...
            if( estado == undefined || nombre == "" || abreviatura == "" || valor == "" )
            {               
                swal({
            ...
            {
                $.ajax({
                    data : {"pnombre": nombre, "pabreviatura": abreviatura, "pvalor": valor, "pestado": estado}, 
                    type: "POST",
                    dataType: "html",
                            ...
                            <form id="form_validation" method="POST">
                                ...
                                <div class="form-group" style="clear: both;">
                                    <div style="float: left;">                                     
                                        ...
                                        <input type="text" class="form-control" name="valor" id="valor" maxlength="2" value="" required>    
                                        </div>
                                    </div>                                        
                                </div>
