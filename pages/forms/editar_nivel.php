...
$query_rs_tabla = "SELECT IdNivel FROM nivel WHERE IdNivel = $idNivel; "; 
...
if( $totalRows_rs_tabla == 1 )
{
	...
	$insertSQL = "UPDATE nivel SET NombreNivel = '$nombre', Estado = $estado WHERE IdNivel = $idNivel;";
	 mysqli_select_db($cnn_kn, $database_cnn_kn);
