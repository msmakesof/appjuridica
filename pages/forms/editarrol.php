...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tabla = "SELECT IdRol, NombreRol, EstadoRol FROM gen_roles WHERE IdRol = $idTabla ;" ;
...
$totalRows_rs_tabla = mysqli_num_rows($rs_tabla);
	...
	$idtabla = $row_rs_tabla["IdRol"];   
    $NombreRol = trim($row_rs_tabla['NombreRol']);    
    $EstadoEst = $row_rs_tabla['EstadoRol'];
?>
<!DOCTYPE html>
<html>
