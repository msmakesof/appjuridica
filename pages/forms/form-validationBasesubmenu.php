   ...
   <!--  <script src="../../plugins/sweetalert/sweetalert.min.js"></script> -->
    ...
    {           
        ...
        $("#grabar").on('click', function(e) { 
			...
			var link = $("#link").val();
            e.preventDefault();
            if( estado == undefined || menu == "" || nombre == "" || link == "")
            {                 
                swal("Atención:", "Debe digitar un Menu, Nombre, Link y/o seleccionar un Estado.");
                e.stopPropagation();
                return false;
            }
            ...
            {
                $.ajax({
                    data : {"pmenu": menu, "pnombre": nombre, "pestado": estado, "picono": icono, "plink": link},
                    type: "POST",
                    dataType: "html",
                            ...
                            <form id="form_validation" method="POST">
								...
								<div class="form-group" style="clear: both;">
                                    <div style="float: left;">                                     
                                        ...
                                        <div class="col-sm-6">                                       
                                            <select class="selectpicker show-tick" data-live-search="true"  data-width="100%" name="menu" id="menu" required>
                                             <option value="" >Seleccione Opción...</option>
                                                ...
                                                ?>
                                                        <option value="<?php echo $MEN_IdMenu; ?>" >
                                                            <?php echo $MEN_Nombre ; ?>                                                
                                                        </option>
                                                <?php
                                                    }
