...
$query_rs_tabla = "SELECT IdTransportador FROM transportadores WHERE IdTransportador = $idEstudiante; "; 
...
{	
	  $insertSQL = "UPDATE transportadores SET IdTipoDocumentoTransportador = $tipodocumento , NitTransportador = $numerodocumento, NombreTransportador = '$nombre', ApellidosTransportador = '$apellido1', TelefonoTransportador = '$telefono', EstadoTransportador = '$estado', DireccionTransportador ='$direccion', EmailTransportador = '$email', CelularTransportador ='$celular', IdCentroAcopio = $centroacopio WHERE IdTransportador = $idEstudiante;";
	  mysqli_select_db($cnn_kn, $database_cnn_kn);
