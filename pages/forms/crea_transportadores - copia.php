...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_base = "SELECT IdTransportador FROM transportadores WHERE NitTransportador = $numerodocumento AND IdTipoDocumentoTransportador = $tipodocumento;" ;
...
{ 
	$idciudad = $strowreg["IdTransportador"];
...
{
	$insertSQL = "INSERT INTO transportadores (TelefonoTransportador, EstadoTransportador, NombreTransportador, ApellidosTransportador, NitTransportador, DireccionTransportador, CelularTransportador, EmailTransportador, IdTipoDocumentoTransportador, IdCentroAcopio) VALUES ('$telefono', '$estado', '$nombre', '$apellido1', '$numerodocumento', '$direccion', '$celular', '$email', $tipodocumento, $centroacopio);";
