...
$query_rs_tabla = "SELECT IdTransportador FROM transportadores WHERE IdTransportador = $pidtabla; "; 
...
{	
	 $insertSQL = "DELETE FROM transportadores WHERE IdTransportador = $pidtabla; ";
	 mysqli_select_db($cnn_kn, $database_cnn_kn);
