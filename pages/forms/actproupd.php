...
require_once('../../apis/proceso/actuacionprocesal.php');

$idtabla = $mactuacionprocesal['pro_actuacionprocesal']['APR_IdActuacionProcesal'];
$idproceso = $mactuacionprocesal['pro_actuacionprocesal']['APR_IdProceso'];
$IdTipoActuacionProcesal = $mactuacionprocesal['pro_actuacionprocesal']['APR_IdTipoActuacionProcesal'];
$FechaCreacion = $mactuacionprocesal['pro_actuacionprocesal']['APR_FechaCreacion'];
$Observaciones = $mactuacionprocesal['pro_actuacionprocesal']['APR_Observaciones'];
