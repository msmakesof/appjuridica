...
{
    $pmenu = trim($_POST['pmenu']);
    $pmenu = str_replace(' ','%20', $pmenu);
}
...
if(function_exists('curl_init')) // Comprobamos si hay soporte para cURL
{
  ...
  $url = urlServicios."consultadetalle/consultadetalle_men_submenu.php?".$parameters;
  $ch = curl_init();
  ...
  {          
    ...
    //print_r ($m);
    $existe = $m['men_submenu']['existe'];
    if($existe > 0)
    {
      $sigue = "E-Existe un SubMenu registrado con el mismo Nombre.";
    }
    else
    {
      
      $parameters = "insert=insert&Nombre=$pnombre&Icono=$picono&Link=$plink&Estado=$pestado&Menu=$pmenu";
      $soportecURL = "S";
      $url         = urlServicios."consultadetalle/consultadetalle_men_submenu.php?".$parameters;
      $existe      = "";
      $usulocal    = "";
