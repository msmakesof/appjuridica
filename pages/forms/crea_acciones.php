...
$query_rs_base = "SELECT IdAccion FROM gen_acciones WHERE NombreAccion = '$nombre' ;" ;
...
{
  $insertSQL = "INSERT INTO gen_acciones (NombreAccion, EstadoAccion) VALUES ('$nombre', '$estado');";
  mysqli_select_db($cnn_kn, $database_cnn_kn);
