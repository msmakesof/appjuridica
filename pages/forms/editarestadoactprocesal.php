...
//echo $idTabla."<br>";
$Tabla ="ESTADOACTPROCESAL";
$idtabla = 0;

require_once('../../apis/proceso/estadoactprocesal.php');
$Nombre = trim($mestadoactprocesal['pro_estadoactprocesal']['EAP_Nombre']);
$diashabiles = $mestadoactprocesal['pro_estadoactprocesal']['EAP_DiasHabiles'];
$estado = $mestadoactprocesal['pro_estadoactprocesal']['EAP_Estado'];
$idtabla = $mestadoactprocesal['pro_estadoactprocesal']['EAP_IdEstado'];
?>
<!DOCTYPE html>
<html>
