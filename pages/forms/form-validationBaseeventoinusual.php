...
<head>
    ...
    {       
        ...
        $("#grabar").on('click', function(e) {             
            ...
            {
                $.ajax({
                    data : {"pnombre": nombre, "pfechainicio": fechainicio, "pfechafinal": fechafinal, "pestado": estado}, 
                    type: "POST",
                    dataType: "html",
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                                ...
                                <div class="form-group form-float" style="clear: both;">
                                    <label class="form-label">Nombre Evento Inusual</label>
                                    <div class="form-line">
                                ...
                                <div class="form-group form-float" style="clear: both;">
                                    ...
                                    <div class='input-group date form-line' name="fechafinal" id="fechafinal" required>
                                        <input type='text' id="txtFechaFinal" name="txtFechaFinal" class="form-control" readonly/>
                                        <span class="input-group-addon"><span class="glyphicon glyphicon-calendar"></span>
                                        </span>
                                    </div>
                                </div>
