...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tabla = "SELECT IdSucursal, NombreSucursal, EmailSucursal, DireccionSucursal, TelefonoSucursal, EstadoSucursal FROM sucursal WHERE IdSucursal = $idTabla ;" ;
...
$totalRows_rs_tabla = mysqli_num_rows($rs_tabla);
	...
	$idtabla = $row_rs_tabla["IdSucursal"];
    $Nombre = trim($row_rs_tabla['NombreSucursal']);
    $Direccion = $row_rs_tabla['DireccionSucursal'];
    $Email = $row_rs_tabla['EmailSucursal'];    
    $TelefonoFijo = $row_rs_tabla['TelefonoSucursal'];
    $Estado = $row_rs_tabla['EstadoSucursal'];    
?>
<!DOCTYPE html>
<html>
...
<body class="theme-indigo">
	...
	{			
		...
		$("#grabar").on('click', function(e) {
            ...
            if( nombre == "" || direccion == "" || email == "" || telefonofijo == "" || estado == undefined )
            {
            ...
            {  
    			...
    			$.ajax({
    				data : {"nombre": nombre, "direccion": direccion, "email": email, "telefonofijo": telefonofijo, "estado": estado,"idtabla": idtabla},                
    				type: "POST",				
