   ...
   <!--  <script src="../../plugins/sweetalert/sweetalert.min.js"></script> -->
    ...
    {           
        ...
        $("#grabar").on('click', function(e) { 
            ...
            {                 
                swal("Atencion:", "Debe digitar un Nombre y/o seleccionar un Estado y/o dias.");
                e.stopPropagation();
                return false;
            }
    ...
    function existe(parnombre)
        {                       
            alertify.alert("Estado Actuacion Procesal: "+ parnombre +" !Ya se encuentra registrada.");
             $("#msj").html("Echo....");
        }
    </script>    
</head>
