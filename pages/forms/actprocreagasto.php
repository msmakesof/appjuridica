                                    ...
                                    <div class="form-group">
										<div class="col-lg-12 col-md-12 col-sm-12">
											...
											<div class="col-lg-2 col-md-2 col-sm-2">
												<div class="row">
													<label class="form-label">Fecha generación del gasto</label>												
											...
											<div class="col-lg-9 col-md-9 col-sm-9">
												<div class="row">																						
													...
													<div class="form-line">
														<input type="input" class="form-control" name="concepto" id="concepto" maxlength="90" autocomplete="off" required>
													</div>
