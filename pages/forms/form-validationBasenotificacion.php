   ...
   <!--  <script src="../../plugins/sweetalert/sweetalert.min.js"></script> -->
    ...
    {           
        ...
        $("#grabar").on('click', function(e) { 
            ...
            {                 
                swal("Atencion:", "Debe digitar un Nombre y/o seleccionar un Estado y/o Digitar dias habiles.");
                e.stopPropagation();
                return false;
            }
            ...
            {
                $.ajax({
                    data : {"pnombre": nombre, "pestado": estado, "pdias": dias},
                    type: "POST",
                    dataType: "html",
    ...
    function existe(parnombre)
        {                       
            alertify.alert("Estado Notificacion: "+ parnombre +" !Ya se encuentra registrada.");
             $("#msj").html("Echo....");
        }
    </script>    
</head>
                            ...
                            <form id="form_validation" method="POST">
								...
								<div class="form-group form-float">								
                                    ...
                                    <div class="form-line" style="width: 20%">                                        
										<input type="number" pattern="/^-?\d+\.?\d*$/" onKeyPress="if(this.value.length==2) return false;" class="form-control" name="dias" id="dias" min="0" max="31" required />
