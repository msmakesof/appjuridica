...
if(function_exists('curl_init')) // Comprobamos si hay soporte para cURL
{
  ...
  $url = urlServicios."consultadetalle/consultadetalle_gen_tipodocumento.php?".$parameters;
  $ch = curl_init();
  ...
  {          
    ...
    //print_r ($m);
    $existe = $m['gen_tipodocumento']['existe'];
    if($existe > 0)
    {
    ...
    else
    {
      ...
      $parameters = "insert=insert&Nombre=$pnombre&Abreviatura=$pabreviatura&Estado=$pestado";
      $soportecURL = "S";
      $url         = urlServicios."consultadetalle/consultadetalle_gen_tipodocumento.php?".$parameters;
      $existe      = "";
      $usulocal    = "";
