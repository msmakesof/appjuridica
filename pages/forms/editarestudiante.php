...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tabla = "SELECT IdEstudiante, TipoDocumento_EST, NumeroDocumento_EST,  Nombres_EST, Apellido1_EST, Apellido2_EST, Email_EST, Estado_EST, Usuario_EST, Clave_EST, IdCiudad_EST, Direccion_EST, Celular_EST, TelefonoFijo_EST, Sucursal_EST FROM estudiante WHERE IdEstudiante = $idTabla ;" ;
...
$totalRows_rs_tabla = mysqli_num_rows($rs_tabla);
    ...
    $TipoDocumento = trim($row_rs_tabla["TipoDocumento_EST"]);
    $NumeroDocumento = trim($row_rs_tabla['NumeroDocumento_EST']);
    $NombreAlumno = trim($row_rs_tabla['Nombres_EST']);
    $Apellido1 = trim($row_rs_tabla['Apellido1_EST']);
    $Apellido2 = trim($row_rs_tabla['Apellido2_EST']);    
    $EstadoEst = $row_rs_tabla['Estado_EST'];
    $Usuario = $row_rs_tabla['Usuario_EST'];
    $Clave = $row_rs_tabla['Clave_EST'];
    $Ciudad = $row_rs_tabla['IdCiudad_EST'];
    //$Direccion = $row_rs_tabla['Direccion_EST'];
    $Email = $row_rs_tabla['Email_EST'];
    $Celular = $row_rs_tabla['Celular_EST'];
    //$TelefonoFijo = $row_rs_tabla['TelefonoFijo_EST'];        
    //$archivo = $NombreAlumno.".php";    
    $Sucursal = trim($row_rs_tabla['Sucursal_EST']);    
