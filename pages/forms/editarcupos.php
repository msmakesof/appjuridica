...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tabla = "SELECT IdCupo, Cantidad, Estado, Nombre_Estado FROM cupos JOIN gen_estado ON gen_estado.Id_Estado = cupos.Estado WHERE IdCupo = $idTabla ;" ;
...
$totalRows_rs_tabla = mysqli_num_rows($rs_tabla);
	...
	$idtabla = $row_rs_tabla["IdCupo"];
    $Nombre = trim($row_rs_tabla['Cantidad']);
