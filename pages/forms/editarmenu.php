...
$Nombre = trim($mmenu['men_menu']['MEN_Nombre']);
$estado = $mmenu['men_menu']['MEN_Estado'];
$idtabla = $mmenu['men_menu']['MEN_IdMenu'];
$Icono = trim($mmenu['men_menu']['MEN_Icono']);
$Orden = trim($mmenu['men_menu']['MEN_Orden']);
$Link = trim($mmenu['men_menu']['MEN_Link']);
?>
<!DOCTYPE html>
<html>
...
<body class="theme-indigo">
                        ...
                        <div class="body  table-responsive">
                            <form id="form_validation" method="POST">
								...
								<div class="form-group form-float">
                                    ...
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="orden" id="orden" maxlength="2" value="<?php echo $Orden ;?>" required>                                        
                                    </div>
                                </div>
	...
	{			
		...
		$("#grabar").on('click', function(e) {
			...
			$.ajax({
				data : {"nombre": nombre, "estado": estado, "icono": icono, "orden": orden, "link": link, "idtabla": idtabla},
				type: "POST",
				dataType: "html",
