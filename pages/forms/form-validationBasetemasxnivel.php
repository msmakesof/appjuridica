...
$NombreTabla ="TEMASXNIVEL";

mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_sucusuarios = "SELECT IdNivel, NombreNivel, Estado FROM nivel WHERE Estado = 1 ORDER BY NombreNivel ;" ;
...
$rs_materia = mysqli_query($cnn_kn, $query_rs_materia) or die(mysqli_error()."Err.....$query_rs_materia<br>");
   ...
   <!--  <script src="../../plugins/sweetalert/sweetalert.min.js"></script> -->
    ...
    {       
        ...
        $("#grabar").on('click', function(e) 
        {
            ...
            if( nombre == "" || materia == "" || estado == undefined )
            {
            ...
            {                
                ...
                $.ajax({
                    data : {"nombre": nombre, "sucursal": materia, "estado": estado}, 
                    type: "POST",
                    dataType: "html",
                ...
                .done(function( data, textStatus, jqXHR){                 
                    ...
                    if(respstr == "E")
                    { 
                        swal("Atencion:", "Tema  !Ya se encuentra registrado para este Nivel...");
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <div class="col-sm-4">
                                        <select class="selectpicker" data-show-subtext="true" data-live-search="true" data-style="btn-info" name="materia" id="materia" required>
                                                <option value="">Seleccione Topic</option>
                                              <?php                                                 
                                                do                                                 
                                                {           
                                                ...
                                                ?>
                                                <option value="<?php echo $idMateria; ?>" >
