...
<head>
    ...
    {       
        ...
        $("#grabar").on('click', function(e) {             
            ...
            if( estado == undefined || nombre == "" || abreviatura == "" )
            {               
                swal({
            ...
            {
                $.ajax({
                    data : {"pnombre": nombre, "pabreviatura": abreviatura, "pestado": estado}, 
                    type: "POST",
                    dataType: "html",
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                                ...
                                <div class="form-group form-float" style="clear: both;">
                                    ...
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="abreviatura" id="abreviatura" maxlength="3" value="" required>                                       
                                    </div>
                                </div>
