...
<head>
    ...
    {       
        ...
        $("#grabar").on('click', function(e) { 
            ...
            {
                $.ajax({
                    data : {"tipodocumento": tipodocumento, "numerodocumento": numerodocumento, "nombre": nombre, "direccion": direccion, "email": email, "celular": celular, "estado": estado, "fijo": fijo, "tipocliente": tipocliente, "sitioweb": sitioweb, "ciudad": ciudad, "Idempresa": <?php echo $idtabla; ?>}, 
                    type: "POST",
                    dataType: "html",
