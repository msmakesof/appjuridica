...
{  
   ...
   //echo json_encode($misDatosJSON);   
	...
	$soportecURL = "S";
	$url         = urlServicios."consultadetalle/cli_areaxcliente.php?Insert=insert&Items=".json_encode($misDatosJSON);
	$existe      = "";
	$usulocal    = "";
	$siguex      = "";
	//echo "<script>console.log('ins json...'+$url)</script>" ;
