...
$Tabla ="SITIOFRECUENTE";
$idtabla = 0;

require_once('../../apis/general/sitiofrecuente.php');

$Nombre = trim($msitiofrecuente['gen_sitiofrecuente']['SIF_Nombre']);
$Lnk = trim($msitiofrecuente['gen_sitiofrecuente']['SIF_Link']);
$estado = $msitiofrecuente['gen_sitiofrecuente']['SIF_Estado'];
$idtabla = $msitiofrecuente['gen_sitiofrecuente']['SIF_IdSitio'];
...
<body class="theme-indigo">
                        ...
                        <div class="body table-responsive">
                            <form id="form_validation" method="POST">
                                ...
                                <div class="form-group row">
                                    <div class="col-xs-12">
                                        <label class="form-label">Digite Nombre</label>                                       
										<div class="form-line">
								...
								<div class="form-group row">
                                    <div class="col-xs-12">
                                        <label class="form-label">Digite Link del Sitio</label>
                                        <div class="form-line">
                                            <textarea class="form-control" name="lnk" id="lnk" required placeholder="link para dirigir al visitante" rows="3" cols="60">
											<?php echo trim($Lnk); ?>
											</textarea>
                                        </div>
                                    </div>    
	...
	{			
		...
		$("#grabar").on('click', function(e) {
			...
			$.ajax({
				data : {"nombre": nombre, "lnk": lnk, "estado": estado, "idtabla": idtabla},
				type: "POST",
				dataType: "html",
