...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tabla = "SELECT IdSucursal, NombreSucursal, Estado, Nombre_Estado FROM sucursal JOIN gen_estado ON gen_estado.Id_Estado = nivel.Estado WHERE IdNivel = $idTabla ;" ;
...
$totalRows_rs_tabla = mysqli_num_rows($rs_tabla);
	...
	$idtabla = $row_rs_tabla["IdNivel"];
    $Nombre = trim($row_rs_tabla['NombreNivel']);
		...
		$("#grabar").on('click', function(e) {
            ...
            {  
    			...
    			$.ajax({
    				...
    				type: "POST",				
    				url : "editar_<?php echo $Tabla; ?>.php",
                })  
            ...
            alertify.confirm( 'Desea borrar este registro?', function (e) {
                if (e) {
                    ...
                    $.ajax({
                        ...
                        type: "POST",
                        dataType: "html",
                        url : "../forms/borrar_<?php echo $Tabla; ?>.php",
                    })  
                    .done(function( dataX, textStatus, jqXHR ){                       
                        var respstr = dataX;        
                        if( respstr == "S" )
