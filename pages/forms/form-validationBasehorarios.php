    ...
    {       
        ...
        $("#grabar").on('click', function(e) 
        {
            ...
            {                
                ...
                $.ajax({
                    data : {"nombre": nombre, "final": final, "estado": estado}, 
                    type: "POST",
                    dataType: "html",
                ...
                .done(function( data, textStatus, jqXHR){                 
                    ...
                    if(respstr == "E")
                    { 
                        swal("Atencion:", "Horario " + nombre + " !Ya se encuentra registrado(a)...");
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                                ...
                                <!-- <div class="form-group form-float">
                                    <label class="form-label">Horario Inicial </label>
                                    <div class="form-line">
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="final" id="final" value="" required>
                                    ...
                                    <div class="form-group form-float">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="form-line">
                                                    <input type="text" class="form-control time12" name="nombre" id="nombre" placeholder="Ej: 11:59 pm"  >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group form-float">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <div class="form-line">
                                                    <input type="text" class="form-control time12" name="final" id="final" placeholder="Ej: 11:59 pm">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
