...
$query_rs_tabla = "SELECT IdUsuario FROM gen_usuarios WHERE IdUsuario = $idEstudiante; "; 
...
if( $totalRows_rs_tabla == 1 )
{
	...
	if($estado == 1){$estadotxt = "M";}
	$insertSQL = "UPDATE gen_usuarios SET IdTipoDocumento_usuario = $tipodocumento , Identificacion_usuario = '$numerodocumento', Nombre_usuario = '$nombre', Apellido1_usuario = '$apellido1', clave = '$clave', EstadoUsuario = '$estadotxt', Direccion_usuario ='$direccion', Email_usuario = '$email', Telefono_usuario ='$celular', IdCiudad_usuario = $sucursal WHERE IdUsuario = $idEstudiante;";
	 mysqli_select_db($cnn_kn, $database_cnn_kn);
