...
$Nombre = trim($mperiodo['gen_periodo']['PER_Nombre']);
$Abreviatura = trim($mperiodo['gen_periodo']['PER_Abreviatura']);
$Valor = trim($mperiodo['gen_periodo']['PER_Valor']);
$estado = $mperiodo['gen_periodo']['PER_Estado'];
$idtabla = $mperiodo['gen_periodo']['PER_IdPeriodo'];
...
<body class="theme-indigo">
                            ...
                            <label class="form-label">&nbsp;</label>
                                ...
                                <div class="form-group" style="clear: both;">
                                    <div style="float: left;">                                     
                                        ...
                                        <input type="text" class="form-control" name="valor" id="valor" maxlength="2" value="<?php echo $Valor ;?>" required>    
                                        </div>
                                    </div>                                        
                                </div>
	...
	{			
		...
		$("#grabar").on('click', function(e) {
			...
			$.ajax({
				data : {"nombre": nombre, "abreviatura": abreviatura, "valor": valor, "estado": estado, "idtabla": idtabla},
				type: "POST",
				dataType: "html",
				url : "editar_periodo.php",
            })  
