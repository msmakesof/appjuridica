...
$query_rs_base = "SELECT IdNivel FROM nivel WHERE NombreNivel = '$nombre';" ;
...
else
{
	...
	$insertSQL = "INSERT INTO nivel (NombreNivel, Estado) VALUES ('$nombre', $estado);";
