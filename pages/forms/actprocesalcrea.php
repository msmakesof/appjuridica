...
<section>
        ...
        <div class="container-fluid">
            <div class="block-header">
                <div class="form-group form-float">
					<div class="row">
						<div class="col-md-12">
							<span class='label label-danger' style="font-size:13px !important;">FORMULARIO: Creación Actuación Procesal Preliminar <?php echo $Tabla;?>.</span> 
							<span class="badge badge-pill badge-info"><?php //echo $txtEstado; ?></span>
							<!--<small>Editar.</small>-->							
						</div>
					</div>	
                </div>
                            ...
                            <form id="form_validation" method="POST">
								...
								<div class="form-group form-float">
									...
									<div class="row">
										...
										<div class="col-md-6">                                            
                                            <label for="tipo">N&uacute;mero de Radicado / Proceso</label>                                                
                                            <select class="selectpicker show-tick" data-live-search="true" data-width="95%" name="proceso" id="proceso" required>    
												...
												<?php 
													...
													{
														$PRO_NumeroProceso = $mproceso['pro_proceso'][$i]['PRO_NumeroProceso'];                                                
														$APR_IdProceso = $mproceso['pro_proceso'][$i]['APR_IdProceso'];
												?>
													
													<option value="<?php echo $APR_IdProceso; ?>" >
														<?php echo $APR_IdProceso ; ?>                                                
													</option>
	...
	{   		
		...
		$.post('editaractprocesales.php', { 'id': id, 'proceso': proceso }, function (result) {
