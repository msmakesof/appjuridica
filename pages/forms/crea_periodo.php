...
$pvalor ="";
if( isset($_POST['pvalor']) )
{
	  $pvalor = trim($_POST['pvalor']);
}
...
{
  $parameters = "ExisteTabla=1&Nombre=$pnombre&Abreviatura=$pabreviatura&Valor=$pvalor&idtabla=0";
  ...
  {          
    ...
    //print_r ($m);
    $existe = $m['gen_periodo']['existe'];
    if($existe > 0)
    {
      $sigue = "E-Existe un Periodo registrado con el mismo Nombre, Abreviatura y Valor.";
    }
    else
    {
      
      $parameters = "insert=insert&Nombre=$pnombre&Abreviatura=$pabreviatura&Valor=$pvalor&Estado=$pestado";
      $soportecURL = "S";
      $url         = urlServicios."consultadetalle/consultadetalle_gen_periodo.php?".$parameters;
      $existe      = "";
      $usulocal    = "";
