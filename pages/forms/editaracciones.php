...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tabla = "SELECT IdAccion, NombreAccion, EstadoAccion FROM gen_acciones WHERE IdAccion = $idTabla ;" ;
...
$totalRows_rs_tabla = mysqli_num_rows($rs_tabla);
	...
	$idtabla = $row_rs_tabla["IdAccion"];   
    $NombreRol = trim($row_rs_tabla['NombreAccion']);    
    $EstadoEst = $row_rs_tabla['EstadoAccion'];
?>
<!DOCTYPE html>
<html>
                        ...
                        <div class="body  table-responsive">
                            <form id="form_validation" method="POST">                               
                                ...
                                <div class="form-group form-float">
                                    <label class="form-label">Nombre Acci&oacute;n</label>
                                    <div class="form-line">
