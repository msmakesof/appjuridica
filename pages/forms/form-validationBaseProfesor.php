    ...
    {           
        ...
        $("#grabar").on('click', function(e) { 
            ...
            {                
                ...
                $.ajax({
                    data : {"tipodocumento": tipodocumento, "numerodocumento": numerodocumento, "nombre": nombre, "apellido1": apellido1, "clave": clave, "direccion": direccion, "email": email, "celular": celular, "telefonofijo": telefonofijo, "estado": estado, "sucursal": sucursal}, 
                    type: "POST",
                    dataType: "html",
                    url : "crea_profesor.php",
                })  
                .done(function( data, textStatus, jqXHR){                 
                    var respstr = data;
                    if(respstr == "E")
                    { 
                        swal("Atencion:", "Profesor " + nombre + " !Ya se encuentra registrado(a)...");
