...
$query_rs_tabla = "SELECT IdCentroAcopio FROM centrosacopio WHERE IdCentroAcopio = $idEstudiante; "; 
...
{
	$insertSQL = "UPDATE centrosacopio SET NombreCentroAcopio = '$nombre', Estado = $estado WHERE IdCentroAcopio = $idEstudiante;";
	 mysqli_select_db($cnn_kn, $database_cnn_kn);
