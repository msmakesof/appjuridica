...
$query_rs_base = "SELECT IdTemaxNivel FROM temasxnivel WHERE IdNivelTxN = $nivel AND IdTemaTxN = $materia;" ;
...
{ 
	$idciudad = $strowreg["IdTemaxNivel"];
...
else
{
	...
	$insertSQL = "INSERT INTO temasxnivel (IdNivelTxN, IdTemaTxN, IdEstadoTxN) VALUES ($nivel, $materia, $estado);";
