...
$query_rs_base = "SELECT IdSucursal FROM sucursal WHERE NombreSucursal = '$nombre';" ;
...
else
{
	...
	$insertSQL = "INSERT INTO sucursal (NombreSucursal, DireccionSucursal, EmailSucursal, TelefonoSucursal, EstadoSucursal) VALUES ('$nombre', '$direccion', '$email', '$telefonofijo', $estado);";
