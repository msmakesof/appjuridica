...
$Nombre = trim($mclaseproceso['pro_claseproceso']['CPR_Nombre']);
$Dias = $mclaseproceso['pro_claseproceso']['CPR_Dias'];
$estado = $mclaseproceso['pro_claseproceso']['CPR_Estado'];
$idtabla = $mclaseproceso['pro_claseproceso']['CPR_IdClaseProceso'];
?>
<!DOCTYPE html>
<html>
...
<body class="theme-indigo">
	...
	{			
		...
		$("#grabar").on('click', function(e) {
			...
			$.ajax({
				data : {"nombre": nombre, "dias": dias, "estado": estado, "idtabla": idtabla},
				type: "POST",
				dataType: "html",
