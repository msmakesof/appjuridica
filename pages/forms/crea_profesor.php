...
$query_rs_base = "SELECT IdProfesor FROM profesores WHERE NumeroDocumento_PRO = $numerodocumento AND TipoDocumento_PRO = $tipodocumento;" ;
...
else
{
	...
	$insertSQL = "INSERT INTO profesores (TipoDocumento_PRO , NumeroDocumento_PRO, Nombres_PRO, Apellido1_PRO, Clave_PRO, Estado_PRO, Direccion_PRO, Email_PRO, Celular_PRO, TelefonoFijo_PRO, Sucursal_PRO, FechaCreacion_PRO, IdCiudad_PRO) VALUES ($tipodocumento, $numerodocumento,'$nombre', '$apellido1', '$clave', $estado, '$direccion', '$email', '$celular', '$telefonofijo', $sucursal, Now(), 0);";
