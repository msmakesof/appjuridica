...
$pfechafinal ="";
if( isset($_POST['pfechafinal']) )
{
	  $pfechafinal = trim($_POST['pfechafinal']);
}
...
{
  $parameters = "ExisteTabla=1&Nombre=$pnombre&Fechainicio=$pfechainicio&Fechafinal=$pfechafinal&idtabla=0";
  ...
  {          
    ...
    //print_r ($m);
    $existe = $m['gen_eventoinusual']['existe'];
    if($existe > 0)
    {
      $sigue = "E-Existe un Evento Inusual registrado con el mismo Nombre o Fechas.";
    }
    else
    {
      
      $parameters = "insert=insert&Nombre=$pnombre&Fechainicio=$pfechainicio&Fechafinal=$pfechafinal&Estado=$pestado";
      $soportecURL = "S";
      $url         = urlServicios."consultadetalle/gen_eventoinusual.php?".$parameters;
      $existe      = "";
      $usulocal    = "";
