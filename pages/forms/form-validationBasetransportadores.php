   ...
   <!--  <script src="../../plugins/sweetalert/sweetalert.min.js"></script> -->
    ...
    {           
        ...
        {             
            ...
            {
                $.ajax({
                    data : {"tipodocumento": tipodocumento, "numerodocumento": numerodocumento, "nombre": nombre, "apellido1": apellido1, "telefono": telefono, "direccion": direccion, "email": email, "celular": celular, "estado": estado, "centroacopio": centroacopio}, 
                    type: "POST",
                    dataType: "html",
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
                               ...
                               <!--  <div class="form-group form-float">
                                    ...
                                    <div class="form-line">
                                        <input type="password" class="form-control" name="nit" id="nit" value="" maxlength="20" required>
                                    </div>
                                </div> -->
                                ...
                                <div class="form-group form-float">
                                    <div style="float: left;">
                                        <div class="col-sm-4">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="telefono" id="telefono" value="" maxlength="20" required>
                                            </div>
                                        </div>
                                    </div>
