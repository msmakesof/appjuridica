...
$ppais ="";
if( isset($_POST['ppais']) )
{
	$ppais = trim($_POST['ppais']);
...
if(function_exists('curl_init')) // Comprobamos si hay soporte para cURL
{
  ...
  {          
    ...
    //print_r ($m);
    $existe = $m['gen_departamento']['existe'];
    if($existe > 0)
    {
      $sigue = "E-Existe un Departamento registrado con el mismo Nombre.";
    }
    else
    {
