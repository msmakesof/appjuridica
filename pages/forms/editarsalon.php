...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tabla = "SELECT IdSalon, NombreSalon, Estado, Sucursal, Nombre_Estado FROM salon JOIN gen_estado ON gen_estado.Id_Estado = salon.Estado WHERE IdSalon = $idTabla ;" ;
...
$totalRows_rs_tabla = mysqli_num_rows($rs_tabla);
	...
	$idtabla = $row_rs_tabla["IdSalon"];
    $Nombre = trim($row_rs_tabla['NombreSalon']);
    $Sucursal = $row_rs_tabla['Sucursal'];
...
<body class="theme-indigo">
	...
	{			
		...
		$("#grabar").on('click', function(e) {
            ...
            if( nombre == "" || sucursal == "" || estado == undefined )
            {
            ...
            {  
    			...
    			$.ajax({
    				data : {"nombre": nombre, "sucursal": sucursal, "estado": estado, "idtabla": idtabla},                
    				type: "POST",				
