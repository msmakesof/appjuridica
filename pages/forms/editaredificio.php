...
$Nombre = trim($medificio['gen_edificio']['EDI_Nombre']);
$Direccion = trim($medificio['gen_edificio']['EDI_Direccion']);
$estado = $medificio['gen_edificio']['EDI_Estado'];
$idtabla = $medificio['gen_edificio']['EDI_IdEdificio'];
...
<body class="theme-indigo">
	...
	{			
		...
		$("#grabar").on('click', function(e) {
			...
			$.ajax({
				data : {"nombre": nombre, "direccion": direccion, "estado": estado, "idtabla": idtabla},
				type: "POST",
				dataType: "html",
				url : "editar_edificio.php",
            })  
