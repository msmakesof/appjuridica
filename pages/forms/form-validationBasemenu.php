   ...
   <!--  <script src="../../plugins/sweetalert/sweetalert.min.js"></script> -->
    ...
    {           
        ...
        $("#grabar").on('click', function(e) { 
			...
			var link = $("#link").val();
            e.preventDefault();
            if( estado == undefined || nombre == "" || icono == "" || orden == "" )
            {                 
                swal("Atención:", "Debe digitar un Nombre, Icono, Orden y/o seleccionar un Estado.");
                e.stopPropagation();
                return false;
            }
            ...
            {
                $.ajax({
                    data : {"pnombre": nombre, "pestado": estado, "picono": icono, "porden": orden, "plink": link} ,
                    type: "POST",
                    dataType: "html",
                        ...
                        <div class="body">
                            <form id="form_validation" method="POST">
								...
								<div class="form-group form-float">
                                    <label class="form-label">&nbsp;</label>
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="orden" id="orden" maxlength="2" required>
