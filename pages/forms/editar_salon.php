...
$query_rs_tabla = "SELECT IdSalon FROM salon WHERE IdSalon = $idSalon; "; 
...
if( $totalRows_rs_tabla == 1 )
{
	...
	$insertSQL = "UPDATE salon SET NombreSalon = '$nombre', Sucursal = $sucursal, Estado = $estado WHERE IdSalon = $idSalon;";
	 mysqli_select_db($cnn_kn, $database_cnn_kn);
