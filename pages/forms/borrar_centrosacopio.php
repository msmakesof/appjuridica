...
$query_rs_tabla = "SELECT IdCentroAcopio FROM centrosacopio WHERE IdCentroAcopio = $pidtabla; "; 
...
{	
	 $insertSQL = "DELETE FROM centrosacopio WHERE IdCentroAcopio = $pidtabla; ";
	 mysqli_select_db($cnn_kn, $database_cnn_kn);
