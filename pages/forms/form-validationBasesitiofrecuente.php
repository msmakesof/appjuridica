...
<head>
    ...
    {                        
        ...
        $("#grabar").on('click', function(e) {             
            ...
            if( estado == undefined || nombre == "" || lnk == "" )
            {               
                swal({
            ...
            {
                $.ajax({
                    data : {"pnombre": nombre, "plnk": lnk, "pestado": estado},
                    type: "POST",
                    dataType: "html",
                            ...
                            <form id="form_validation" method="POST">
                                ...
                                <div class="form-group row">                                    
                                    <div class="col-xs-12">
										...
										<div class="form-line">
                                            <input type="text" class="form-control" name="nombre" id="nombre" value="" required placeholder="Digite Nombre">                                       
                                        </div>                                    
                                    </div>                                    
                                </div>                               
								...
								<div class="form-group row">
                                    <div class="col-xs-12">
                                        ...
                                        <div class="form-line">
                                            <textarea class="form-control" name="lnk" id="lnk" value="" required placeholder="link para dirigir al visitante" rows="3" cols="60"></textarea>                                        
                                        </div>
                                    </div>    
                                </div> 								
