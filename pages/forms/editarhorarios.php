...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tabla = "SELECT IdHorario, Inicio, Final, Estado, Nombre_Estado FROM horario JOIN gen_estado ON gen_estado.Id_Estado = horario.Estado WHERE IdHorario = $idTabla ;" ;
...
$totalRows_rs_tabla = mysqli_num_rows($rs_tabla);
	...
	$idtabla = $row_rs_tabla["IdHorario"];
    $Nombre = trim($row_rs_tabla['Inicio']);
    $Final = trim($row_rs_tabla['Final']);    
    $Estado = $row_rs_tabla['Estado'];    
?>
<!DOCTYPE html>
<html>
                            ...
                            <form id="form_validation" method="POST">
                               ...
                               <!-- 
                                ...
                                <div class="form-group form-float">
                                    ...
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="final" id="final" value="<?php echo $Final ;?>" required>
                                ...
                                <div class="demo-masked-input">    
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control time12" name="nombre" id="nombre" placeholder="Ej: 11:59 pm" value="<?php echo $Nombre ;?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="demo-masked-input">    
                                    <div class="col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="form-line">
                                                <input type="text" class="form-control time12" name="final" id="final" placeholder="Ej: 11:59 pm" value="<?php echo $Final ;?>" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<!--     <script src="../../js/pages/forms/form-validation.js"></script>    
	...
	{			
		...
		$("#grabar").on('click', function(e) {
            ...
            if( nombre == "" || final == "" || estado == undefined )
            {
            ...
            {  
    			...
    			$.ajax({
    				data : {"nombre": nombre, "final": final, "estado": estado, "idtabla": idtabla},                
    				type: "POST",				
