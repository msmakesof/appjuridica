   ...
   <!--  <script src="../../plugins/sweetalert/sweetalert.min.js"></script> -->
    ...
    {           
        ...
        {             
            ...
            if( tipodocumento == "" || numerodocumento =="" || nombre == "" || telefono =="" || direccion == "" || email == "" || celular == "" || estado == undefined || ciudad == "" || transportador == "")
            {               
                swal({
            ...
            {
                $.ajax({
                    data : {"tipodocumento": tipodocumento, "numerodocumento": numerodocumento, "nombre": nombre, "telefono": telefono, "direccion": direccion, "email": email, "celular": celular, "estado": estado, "ciudad": ciudad, "transportador" : transportador}, 
                    type: "POST",
                    dataType: "html",
