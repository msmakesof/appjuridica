...
require_once('../../apis/general/accion.php');
$Nombre = trim($maccion['usu_accion']['ACC_Nombre']);
$estado = $maccion['usu_accion']['ACC_Estado'];
$idtabla = $maccion['usu_accion']['ACC_IdAccion'];
