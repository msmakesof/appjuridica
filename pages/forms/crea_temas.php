...
$query_rs_base = "SELECT IdMateria FROM materia WHERE NombreMateria = '$nombre';" ;
...
else
{
	...
	$insertSQL = "INSERT INTO materia (NombreMateria, Estado) VALUES ('$nombre', $estado);";
