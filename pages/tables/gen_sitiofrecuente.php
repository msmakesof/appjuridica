...
<?php
$soportecURL = "S";
$url         = urlServicios."consultadetalle/gen_sitiofrecuente.php?IdMostrar=0";
$existe      = "";
$usulocal    = "";
$siguex      = "";
...
if(function_exists('curl_init')) // Comprobamos si hay soporte para cURL
{
    ...
    //echo("<script>console.log('PHP: ".print_r($msitiofrecuente)."');</script>");
    //echo("<script>console.log('PHP: ".count($m['gen_sitiofrecuente'])."');</script>");
...
if( $msitiofrecuente['estado'] < 2)
{
    $nombre_Tabla="";
    for($i=0; $i<count($msitiofrecuente['gen_sitiofrecuente']); $i++)
    {
        $NombreTabla = trim($msitiofrecuente['gen_sitiofrecuente'][$i]['SIF_Nombre']);
		//$Texto = trim($msitiofrecuente['gen_sitiofrecuente'][$i]['SIF_Nombre']);
		$Link = trim($msitiofrecuente['gen_sitiofrecuente'][$i]['SIF_Link']);
        $archivo = $NombreTabla.".php";
        $idTabla = $msitiofrecuente['gen_sitiofrecuente'][$i]['SIF_IdSitio'];		
        $estadoTabla = trim($msitiofrecuente['gen_sitiofrecuente'][$i]['EstadoTabla']);
    ?>
        <tr>
            <td>
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content" >
				...
				<div class="modal-body">
					<object style="padding :0px; position: relative; height: 60vh; max-height:100vh; bottom:0; overflow: hidden; margin: 0px;" type="text/html" data="../forms/editar<?php echo $nombre_lnk ;?>.php" id="carga"></object>                           
				</div>
	...
	<div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
		<div class="modal-dialog" role="document">
			<div class="modal-content" >
				...
				<div class="modal-body">                         
					<object style="padding :0px; position: relative; height: 60vh; max-height:100vh; bottom:0; overflow: hidden; margin: 0px;" type="text/html" data="../forms/form-validationBase<?php echo $nombre_lnk ;?>.php" id="crear"></object>
				</div>
				<div class="modal-footer">
					<!-- <button type="button" class="btn btn-link waves-effect">SAVE CHANGES</button> -->
