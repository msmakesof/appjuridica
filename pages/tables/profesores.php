                ...
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--1">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                       <li>
                                       <a href="javascript:void(0);" onclick="crear('../forms/form-validationBaseProfesor.php')" class="btn btn-warning btn-xs waves-effect" data-toggle="modal" data-target="#defaultModal">Nuevo</a>
                        ...
                        <div class="body table-responsive" id="zonaquery">
                         <table class="table  table-responsive table-bordered table-striped table-hover dataTable js-exportable" id="grid">
                                <thead>
                                    <tr>
                                        <th>Nombre</th>
...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT concat_WS(' ',Nombres_PRO, Apellido1_PRO) AS NombreProfesor, IdProfesor, NumeroDocumento_PRO, NombreTipoDocumento, Email_PRO, Direccion_PRO, Celular_PRO, NombreSucursal FROM profesores JOIN tipodocumento ON profesores.TipoDocumento_PRO = tipodocumento.IdTipoDocumento JOIN sucursal ON profesores.Sucursal_PRO = sucursal.IdSucursal ORDER BY NombreProfesor;";
...
$nombre_Tabla="";
do{
	$NombreProfesor = trim($row_rs_tipo_tabla['NombreProfesor']);
	$archivo = $NombreProfesor.".php";
	$idTabla = $row_rs_tipo_tabla['IdProfesor'];
    $NumeroDocumento = trim($row_rs_tipo_tabla['NumeroDocumento_PRO']);
	$NombreTipoDocumento = trim($row_rs_tipo_tabla['NombreTipoDocumento']);
    $Email = $row_rs_tipo_tabla['Email_PRO'];
    $Direccion = $row_rs_tipo_tabla['Direccion_PRO'];
    $Celular = $row_rs_tipo_tabla['Celular_PRO'];
    $NombreSucursal = $row_rs_tipo_tabla['NombreSucursal'];    
?>
    <tr>
        <td>
        	<a href="javascript:void(0);" onclick="cambiar('../forms/editarprofesor.php?f=<?php echo $idTabla; ?>')" class="nav nav-tabs nav-stacked" data-toggle="modal" data-target="#defaultModalEditar" style="text-decoration:none;"><?php echo $NombreProfesor; ?></a>        	
        ...
        <td><?php echo $NombreTipoDocumento; ?></td> 
            ...
            <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content" >
                        ...
                        <div class="modal-body">                         
                            <object type="text/html" data="../forms/form-validationBaseProfesor.php" id="crear"></object>
                        </div>
                        <div class="modal-footer">
