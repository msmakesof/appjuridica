...
<div class="row">
	...
	<div class="col-md-2"> 
		...
		<div class="form-line">
		   <input type="text" class="form-control" name="numerodocumentorl" id="numerodocumentorl" value="" maxlength="13" required placeholder="No digitar puntos ni guiones.">
		</div>
	</div>
	...
	<div class="col-md-4">
		...
		<div class="form-line">
			<input type="text" class="form-control" name="nombrerl" id="nombrerl" value="" required>											   
		</div>
	</div>
	...
	<div class="col-md-4">
		...
		<div class="form-line">
			<input type="text" class="form-control" name="apellido1rl" id="apellido1rl" value="" required>											   
		</div>
	</div> 
</div>
...
<div class="row">
	<div class="col-md-3">
		...
		<div class="form-line">
			<input type="text" class="form-control" name="celularrl" id="celularrl" value="" maxlength="13" required>                                       
		</div>
	</div>
	...
	<div class="col-md-4">
		...
		<div class="form-line">
		   <input type="text" class="form-control" name="emailrl" id="emailrl" value="" maxlength="60" required>                                       
		</div>
	</div>
</div>
...
<div class="row">
	...
	<div class="col-md-2"> 
		...
		<div class="form-line">
		   <input type="text" class="form-control" name="numerodocumentorl2" id="numerodocumentorl2" value="" maxlength="13" required placeholder="No digitar puntos ni guiones.">
		</div>
	</div>
	...
	<div class="col-md-4">
		...
		<div class="form-line">
			<input type="text" class="form-control" name="nombrerl2" id="nombrerl2" value="" required>											   
		</div>
	</div>
	...
	<div class="col-md-4">
		...
		<div class="form-line">
			<input type="text" class="form-control" name="apellidosrl2" id="apellidosrl2" value="" required>											   
		</div>
	</div> 
</div>
...
<div class="row">
	<div class="col-md-3">
		<label class="form-label">N&uacute;mero Celular</label>
		<div class="form-line">
			<input type="text" class="form-control" name="celularrl2" id="celularrl2" value="" maxlength="13" required>                                       
		</div>
	</div>
	...
	<div class="col-md-4">
		<label class="form-label">Email</label>
		<div class="form-line">
		   <input type="text" class="form-control" name="emailrl2" id="emailrl2" value="" maxlength="60" required>                                       
		</div>
	</div>
</div>
