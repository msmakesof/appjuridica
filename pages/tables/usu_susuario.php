...
$soportecURL = "S";
$url         = urlServicios."consultadetalle/consultadetalle_Usuario.php?IdMostrarSU=0";
$existe      = "";
$usulocal    = "";
$siguex      = "";
...
?>
    ...
    $(document).ready(function () {	 
		...
		$("#nuevo").on("click", function(){        
			window.location = 'usuarioformas.php';
		});
    });

	function editar(id) 
	{    	
		$.post('../forms/editarusuarios.php', { 'id': id }, function (result) {
