        ...
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    ...
                    <small>Opciones: <a href="#" target="_blank">consultar/actualizar Proceso.</a></small>
                </h2>
            </div>
							...
							<form id="form_validation" method="POST" autocomplete="ÑÖcompletes">
								...
								<div id="example">
									...
									<script id="treeview" type="text/kendo-ui-template">
										...
										#: item.text #
										<a class='k-icon k-i-close-outline telerik' href='\#'></a>
										# } else if (item.items && item.spriteCssClass){ #
										#: item.text #
										# } else { #
									...
									<script>
										...
										$(document).on("click", ".k-icon.k-i-close-outline.telerik", function (e) {
											e.preventDefault();
									...
									<style>
										...
										#example .k-treeview:first-of-type {
											width: 270px;
											margin-right: 1px;
										}
