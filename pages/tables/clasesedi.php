...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT * FROM clases WHERE IdClase = $xclasepar ;";
...
<body class="theme-red">
    ...
    <div class="body">
        <div class="container-fluid">
            ...
            <object type="text/html" data="../../Calendario/editarclases.php?x=<?php echo $xclasepar; ?>" id="carga" style="height: 780px; width: 100%; margin: 2px;"></object> 
        </div>
    </div>    
    </section>
