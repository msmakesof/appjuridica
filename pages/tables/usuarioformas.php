...
<head>
    ...
    {       
		...
		$("#cerrar").on('click', function(e) {
            e.preventDefault();
            window.location = 'usu_susuario.php';
        });
        ...
        $("#grabar").on('click', function(e) {
            ...
            {
                $.ajax({
                    data : {"empresa": empresa, "tipodocumento": tipodocumento, "numerodocumento": numerodocumento, "nombre": nombre, "apellido1": apellido1, "apellido2": apellido2, "clave": clave, "direccion": direccion, "email": email, "celular": celular, "estado": estado, "tipousuario": tipousuario, "abogado": abogado, "SuperAdmin": 1}, 
                    type: "POST",
                    dataType: "html",
                    url : "../forms/crea_usuarios.php",
                })  
