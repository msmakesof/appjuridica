...
<head>
    ...
    {   		
        ...
        $("#cerrar").on('click', function(e) {
            e.preventDefault();
            window.location = 'cli_cliented.php';
        }); 
        ...
        $("#grabar").on('click', function(e) { 
			...
			*/
				if( tipodocumento == 2)
				{
					...
					if( tipodocumento == "" || tipodocumentorl == "" || numerodocumento == "" || numerodocumento == 0 || nombre == "" || direccion == "" || email == "" || numerodocumentorl == "" || numerodocumentorl == 0 || nombrerl  == "" || apellido1rl == "" || empresa == "")
					{
						graba = 0;
						swal({
						...
						{    
							...
							{  
								setTimeout(function () { 
									...
									function(isConfirm){
										if (isConfirm) {
											window.location.href = "cli_cliented.php";
										}
									}); 
								}, 1000);
    ...
    <section class="content" style="margin-top:85px;">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    FORMULARIO: <?php echo "DEMANDADO" //$NombreTabla; ?>.
