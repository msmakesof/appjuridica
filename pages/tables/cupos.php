...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT Cantidad, IdCupo, Nombre_Estado FROM cupos JOIN gen_estado ON gen_estado.Id_Estado = cupos.Estado ORDER BY Cantidad;";
...
$nombre_Tabla="";
do{
	$Nombre = $row_rs_tipo_tabla['Cantidad'];    
	$archivo = $Nombre.".php";
	$idTabla = $row_rs_tipo_tabla['IdCupo'];    
