...
$soportecURL = "S";
$url         = urlServicios."consultadetalle/consultadetalle_men_submenu.php?IdMostrar=0";
$existe      = "";
$usulocal    = "";
$siguex      = "";
...
{
    $nombre_Tabla="";
    for($i=0; $i<count($msubmenu['men_submenu']); $i++)
    {
        $NombreTabla = trim($msubmenu['men_submenu'][$i]['SME_Nombre']);        
        $archivo = $NombreTabla.".php";
        $idTabla = $msubmenu['men_submenu'][$i]['SME_IdSubMenu'];
		$idMenu = $msubmenu['men_submenu'][$i]['SME_IdMenu'];
		$nombreMenu = $msubmenu['men_submenu'][$i]['NombreMenu'];
		$Icono = $msubmenu['men_submenu'][$i]['SME_Icono'];
		$Link = $msubmenu['men_submenu'][$i]['SME_Link'];
        $estadoTabla = trim($msubmenu['men_submenu'][$i]['EstadoTabla']);
    ?>
        <tr>
            <td>
			...
			<td><?php echo $nombreMenu; ?></td>	
			<td style="width:15% !important"><?php echo $Link; ?></td>
...
<script type="text/javascript">
 $(document).ready(function () {	 
	$("#cerrarModal").click(function(){
	 	 window.location="men_<?php echo $nombre_lnk ;?>.php";
	});
