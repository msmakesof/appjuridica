...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT IdConductor, Nombres, IdTransportador, Nit, IdCiudad, Direccion, Telefono, Celular, Email, FechaVencePase, EstadoConductor FROM conductores ORDER BY Nombres ;";
...
$nombre_Tabla="";
do{
	$NombreUsuario = trim($row_rs_tipo_tabla['Nombres']);
	$archivo = $NombreUsuario.".php";
	$idTabla = $row_rs_tipo_tabla['IdConductor'];
    $nit = $row_rs_tipo_tabla['Nit'];    
    $Email = trim($row_rs_tipo_tabla['Email']);
    $Direccion = trim($row_rs_tipo_tabla['Direccion']);
	$EstadoUsuario = trim($row_rs_tipo_tabla['EstadoConductor']);
?>
    <tr>
        <td>
