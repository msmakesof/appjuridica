                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--1">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                       <li>
                                       <a href="javascript:void(0);" onclick="crear('../forms/form-validationBaseSedes.php')" class="btn btn-warning btn-xs waves-effect" data-toggle="modal" data-target="#defaultModal">Nuevo</a>
...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT NombreSucursal, IdSucursal, EmailSucursal, DireccionSucursal, TelefonoSucursal, Nombre_Estado FROM sucursal JOIN gen_estado ON gen_estado.Id_Estado = sucursal.EstadoSucursal ORDER BY NombreSucursal;";
...
do{
	...
	$archivo = $NombreSucursal.".php";
	$idTabla = $row_rs_tipo_tabla['IdSucursal'];
    $Email = $row_rs_tipo_tabla['EmailSucursal'];
    $Direccion = $row_rs_tipo_tabla['DireccionSucursal'];
    $Celular = $row_rs_tipo_tabla['TelefonoSucursal'];
    $Nombre_Estado = $row_rs_tipo_tabla['Nombre_Estado'];        
?>
    <tr>
        <td>
        	<a href="javascript:void(0);" onclick="cambiar('../forms/editar<?php echo $nombre_lnk; ?>.php?f=<?php echo $idTabla; ?>')" class="nav nav-tabs nav-stacked" data-toggle="modal" data-target="#defaultModalEditar" style="text-decoration:none;"><?php echo $NombreSucursal; ?></a>        	
