                        ...
                        <div class="body table-responsive" id="zonaquery">
							<table class="table table-bordered table-striped table-hover dataTable js-exportable" id="grid">
                                <thead>
                                    <tr>
                                        <th>Empresa</th>										
										<th>Corporaci&oacute;n / Jurisdicci&oacute;n</th>
										<th>Area</th>
                                        <th>Estado</th> 
                                    </tr>
                                </thead>
								...
								if( $mareaxcliente['estado'] < 2)
								{
									...
									for($i=0; $i<count($mareaxcliente['cli_areaxcliente']); $i++)
									{
										...
										//{
										/*	
											$NomEmpresa = $NombreTabla;
											if( $NomEmpresa == $NombreTabla )
											{
												if( $NomEmpresaAct != $NomEmpresa && $i == 0)
												{
													$NomEmpresaAct = $NomEmpresa;	
												}
												else
												{
										...
										*/	
										...
										{
											if( $categoria_actual != $NombreArea )
											{
												$categoria_actual .= $NombreArea;
											}
										}
									...
									?>
										...
										<tr>
											...
											<td><?php echo $categoria_actual ; ?></td>               
										</tr>
