            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li>
                        ...
                        <ul class="ml-menu">
                            <li>
                                <a href="../../pages/charts/morris.html">Indicadores</a>
                            </li>
                            <li>
                                <a href="../../pages/charts/flot.html">Gráficas</a>
                            </li>
                            <li>
                                <a href="../../pages/charts/chartjs.html">Estadísticas</a>
                            </li>
                            <li>
                                <a href="../../pages/charts/sparkline.html">Reportes</a>
                            </li>
                            <li>
                                <a href="../../pages/charts/jquery-knob.html">Otros</a>
                            </li>
                        </ul>
                    </li>
                    <!--
        ...
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    ...
                    <small>Opciones: <a href="#" target="_blank">consultar, editar, modificar.</a></small>
                </h2>
            </div>
                        ...
                        <div class="header">
                            ...
                            <ul class="header-dropdown m-r--5">
                                <li class="dropdown">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <li>
                                       <a href="javascript:void(0);" class="btn btn-default waves-effect m-r-20" data-toggle="modal" data-target="#defaultModal">Nuevo</a>
...
?>
    <tr>
        <td>
        	<a href="javascript:void(0);" onclick="cambiar('../forms/editartabla.php?f=<?php echo $idTabla; ?>')" class="btn btn-default waves-effect m-r-20" data-toggle="modal" data-target="#defaultModalEditar"><?php echo $NombreTabla; ?></a>
            <!-- Default Editar -->
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content" >
                       <!-- <div class="modal-header">
                        ...
                        <div class="modal-body">                         
                            <object type="text/html" data="../forms/form-validationBase.html"></object>
                        </div>
                        <div class="modal-footer">
                            <!-- <button type="button" class="btn btn-link waves-effect">SAVE CHANGES</button> -->
                            <button type="button" class="btn btn-link waves-effect" data-dismiss="modal" id="cerrarModal">CERRAR</button>
