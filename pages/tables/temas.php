...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT NombreMateria, IdMateria, Nombre_Estado FROM materia JOIN gen_estado ON gen_estado.Id_Estado = materia.Estado ORDER BY NombreMateria;";
...
$nombre_Tabla="";
do{
	$Nombre = $row_rs_tipo_tabla['NombreMateria'];    
	$archivo = $Nombre.".php";
	$idTabla = $row_rs_tipo_tabla['IdMateria'];    
