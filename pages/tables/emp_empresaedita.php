...
<head>
    ...
    {       
        ...
        $("#grabar").on('click', function(e) { 
            ...
            if( tipocliente == "" || tipodocumento == "" || numerodocumento =="" || nombre == "" || direccion == "" || email == "" || fijo == "" || celular == "" || estado == undefined || tipocliente == undefined || sitioweb == "" || ciudad == "")
            {               
                swal({
            ...
            {
                $.ajax({
                    data : {"tipodocumento": tipodocumento, "numerodocumento": numerodocumento, "nombre": nombre, "direccion": direccion, "email": email, "celular": celular, "estado": estado, "fijo": fijo, "tipocliente": tipocliente, "sitioweb": sitioweb, "ciudad": ciudad}, 
                    type: "POST",
                    dataType: "html",
									...
									<div class="row">
										<div class="col-lg-4 col-md-4 col-sm-4 col-xs-3">										
											...
											<select class="selectpicker show-tick" data-live-search="true" data-width="100%" name="tipocliente" id="tipocliente" required>
												...
												?>
														<option value="<?php echo $TPE_IdTipoPersona; ?>" >
															<?php echo $TPE_Nombre ; ?>                                                
														</option>
												<?php
													}
