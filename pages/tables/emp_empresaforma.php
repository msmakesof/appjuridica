    ...
    {       
        ...
        $("#grabar").on('click', function(e) {             
            ...
            else
            {
				...
				{
					$.ajax({
						data : {"tipodocumento": tipodocumento, "numerodocumento": numerodocumento, "nombre": nombre, "nombre2": nombre2, "apellido1": apellido1, "apellido2": apellido2, "direccion": direccion, "email": email, "celular": celular, "estado": estado, "fijo": fijo, "tipocliente": tipocliente, "sitioweb": sitioweb, "ciudad": ciudad}, 
						type: "POST",
						dataType: "html",
