...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT IdAccion, NombreAccion, CASE EstadoAccion WHEN 1 THEN 'Activo' ELSE 'Inactivo' END EstadoAccion FROM gen_acciones WHERE NombreAccion <> '' ;";
...
$nombre_Tabla="";
do{
	$NombreUsuario = trim($row_rs_tipo_tabla['NombreAccion']);
	$archivo = $NombreUsuario.".php";
	$idTabla = $row_rs_tipo_tabla['IdAccion'];        
	$EstadoUsuario = trim($row_rs_tipo_tabla['EstadoAccion']);
?>
    <tr>
        <td>
           <a href="javascript:void(0);" onclick="cambiar('../forms/editaracciones.php?f=<?php echo $idTabla; ?>')" class="nav nav-tabs nav-stacked" data-toggle="modal" data-target="#defaultModalEditar" style="text-decoration:none;"><?php echo $NombreUsuario; ?></a>
