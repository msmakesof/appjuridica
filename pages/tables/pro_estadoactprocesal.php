...
$soportecURL = "S";
$url         = urlServicios."consultadetalle/consultadetalle_pro_estadoactprocesal.php?IdMostrar=0";
$existe      = "";
$usulocal    = "";
$siguex      = "";
...
if(function_exists('curl_init')) // Comprobamos si hay soporte para cURL
{
    ...
    //echo("<script>console.log('PHP: ".print_r($mestadoactprocesal)."');</script>");
    //echo("<script>console.log('PHP: ".count($m['pro_estadoactprocesal'])."');</script>");
...
if($soportecURL == "N")
{
    ...
    $mestadoactprocesal = json_decode($resultado, true);	        
} 

if( $mestadoactprocesal['estado'] < 2)
{
    $nombre_Tabla="";
    for($i=0; $i<count($mestadoactprocesal['pro_estadoactprocesal']); $i++)
    {
        $NombreTabla = trim($mestadoactprocesal['pro_estadoactprocesal'][$i]['EAP_Nombre']);        
        $archivo = $NombreTabla.".php";
        $idTabla = $mestadoactprocesal['pro_estadoactprocesal'][$i]['EAP_IdEstado'];
        $diasHabiles = $mestadoactprocesal['pro_estadoactprocesal'][$i]['EAP_DiasHabiles'];
        $estadoTabla = trim($mestadoactprocesal['pro_estadoactprocesal'][$i]['EstadoTabla']);
    ?>
        <tr>
            <td>
