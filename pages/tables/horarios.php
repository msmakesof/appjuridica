...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT Inicio, Final, IdHorario, Nombre_Estado FROM horario JOIN gen_estado ON gen_estado.Id_Estado = horario.Estado ORDER BY Inicio, Final;";
...
$nombre_Tabla="";
do{
	$Nombre = $row_rs_tipo_tabla['Inicio'];
    $Final = $row_rs_tipo_tabla['Final'];
	$archivo = $Nombre.".php";
	$idTabla = $row_rs_tipo_tabla['IdHorario'];
