...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT Id_Estado, Nombre_Estado FROM gen_estado  ORDER BY Nombre_Estado;";
...
$nombre_Tabla="";
do{		
	$idTabla = $row_rs_tipo_tabla['Id_Estado'];    
    $Nombre = $row_rs_tipo_tabla['Nombre_Estado'];
    $archivo = $Nombre.".php";
?>
    <tr>
        <td>
        	<!-- <a href="javascript:void(0);" onclick="cambiar('../forms/editar<?php echo $nombre_lnk; ?>.php?f=<?php echo $idTabla; ?>')" class="nav nav-tabs nav-stacked" data-toggle="modal" data-target="#defaultModalEditar" style="text-decoration:none;"></a> -->
            <?php echo $Nombre; ?>           
