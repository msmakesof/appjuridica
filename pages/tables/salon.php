...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT NombreSalon, IdSalon, NombreSucursal, Nombre_Estado FROM salon JOIN gen_estado ON gen_estado.Id_Estado = salon.Estado JOIN sucursal ON sucursal.IdSucursal = salon.Sucursal ORDER BY NombreSalon;";
...
$nombre_Tabla="";
do{
	$Nombre = $row_rs_tipo_tabla['NombreSalon'];    
	$archivo = $Nombre.".php";
	$idTabla = $row_rs_tipo_tabla['IdSalon'];    
    $Nombre_Sucursal = $row_rs_tipo_tabla['NombreSucursal']; 
    $Nombre_Estado = $row_rs_tipo_tabla['Nombre_Estado'];        
?>
    <tr>
        <td>
        	<a href="javascript:void(0);" onclick="cambiar('../forms/editar<?php echo $nombre_lnk; ?>.php?f=<?php echo $idTabla; ?>')" class="nav nav-tabs nav-stacked" data-toggle="modal" data-target="#defaultModalEditar" style="text-decoration:none;"><?php echo $Nombre; ?></a>        	
