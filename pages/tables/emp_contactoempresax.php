    ...
    <section class="content">
        <div class="container-fluid">
            <div class="block-header">
                <h2>
                    INFORMACION DE: CONTACTO <?php echo strtoupper($nombre_lnk); ?>
...
if( $mempresa['estado'] < 2)
{
    for($i=0; $i<count($mempresa['emp_empresa']); $i++)
    {
		...
		//trim($mempresa['emp_empresa'][$i]['EMP_Nombre']).' '.trim($mempresa['emp_empresa'][$i]['EMP_Nombre2']).' '.trim($mempresa['emp_empresa'][$i]['EMP_Apellido']).' '.trim($mempresa['emp_empresa'][$i]['EMP_Apellido2']);
		...
		$Identificacion = $mempresa['emp_contactoempresa'][$i]['COE_Documento'];
        //$Direccion = trim($mempresa['emp_contactoempresa'][$i]['EMP_Direccion']);
        //$Ciudad = trim($mempresa['emp_contactoempresa'][$i]['NombreCiudad']);
        ...
        <tr>
			...
			<td>
				<a href="javascript:void(0);" onclick='borraremp(<?php echo $idTabla; ?>,"<?php echo $NombreUsuario; ?>")'>
					<img src="../../images/delContact.png" width="25" height="25">
				</a>
			</td>
        </tr>
    <?php                          
...
?>
	...
	$("#nuevo").on("click", function(){        
        window.location = 'emp_addcontacto.php';
    });
	...
	$("#xnuevo").on("click", function(){
		var id = <?php echo $pid;?>;	
		$.post('../forms/emp_addcontacto.php', { 'id': id }, function (result) {
	...
	function adiContacto(<?php echo $pid;?>) 
	{    	
		$.post('../forms/emp_addcontacto.php', { 'id': id }, function (result) {
			WinId = window.open('','_self');
			WinId.document.open();
