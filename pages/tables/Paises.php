            ...
            <div class="menu">
                <ul class="list">
                    ...
                    <li class="active">
                        ...
                        <?php
                        mysqli_select_db($cnn_kn, $database_cnn_kn);
                        $query_rs_ntipo_tabla = "SELECT Nombre_Tabla FROM geo_paises WHERE Id_EstadoTabla = 1 ORDER BY Nombre_Tabla;"; 
...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT Nombre_Paises, Id_Paises, Codigo_Paises FROM geo_paises ORDER BY Nombre_Paises;";
...
$nombre_Tabla="";
do{
	$NombreTabla = trim($row_rs_tipo_tabla['Nombre_Paises']);
