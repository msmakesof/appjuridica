...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT IdRol, NombreRol, CASE EstadoRol WHEN 1 THEN 'Activo' ELSE 'Inactivo' END EstadoRol FROM gen_roles WHERE NombreRol <> '' ;";
...
$nombre_Tabla="";
do{
	$NombreUsuario = trim($row_rs_tipo_tabla['NombreRol']);
	$archivo = $NombreUsuario.".php";
	$idTabla = $row_rs_tipo_tabla['IdRol'];        
	$EstadoUsuario = trim($row_rs_tipo_tabla['EstadoRol']);
?>
    <tr>
        <td>
           <a href="javascript:void(0);" onclick="cambiar('../forms/editarrol.php?f=<?php echo $idTabla; ?>')" class="nav nav-tabs nav-stacked" data-toggle="modal" data-target="#defaultModalEditar" style="text-decoration:none;"><?php echo $NombreUsuario; ?></a>
