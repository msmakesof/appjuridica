...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT temasxnivel.* ,nivel.NombreNivel, materia.NombreMateria, Nombre_Estado FROM temasxnivel JOIN nivel ON nivel.IdNivel = temasxnivel.IdNivelTxN JOIN materia ON materia.IdMateria = temasxnivel.IdTemaTxN JOIN gen_estado ON gen_estado.Id_Estado = temasxnivel.IdEstadoTxN ORDER BY NombreNivel, NombreMateria;";
...
$nombre_Tabla="";
do{
	$NombreNivel = $row_rs_tipo_tabla['NombreNivel'];    
	$archivo = $NombreNivel.".php";
	$idTabla = $row_rs_tipo_tabla['IdTemaxNivel'];    
    $Nombre_Materia = $row_rs_tipo_tabla['NombreMateria']; 
    $Nombre_Estado = $row_rs_tipo_tabla['Nombre_Estado'];        
?>
    <tr>
        <td>
        	<a href="javascript:void(0);" onclick="cambiar('../forms/editar<?php echo $nombre_lnk; ?>.php?f=<?php echo $idTabla; ?>')" class="nav nav-tabs nav-stacked" data-toggle="modal" data-target="#defaultModalEditar" style="text-decoration:none;"><?php echo $NombreNivel; ?></a>        	
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content" style="height:650px;">
                        ...
                        <div class="modal-body" style="height:600px;">                         
                            <object type="text/html" data="../forms/form-validationBase<?php echo $nombre_lnk; ?>.php" id="crear" style="height:550px;"></object>
                        </div>
                        <div class="modal-footer">
                            <!-- <button type="button" class="btn btn-link waves-effect">SAVE CHANGES</button> -->
                            <button type="button" class="btn btn-info waves-effect" data-dismiss="modal" id="cerrarModalC" style="top:-50px;">CERRAR Crear.</button>
                        </div>
                    </div>
                </div>
            </div>
