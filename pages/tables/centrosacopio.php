...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT IdCentroAcopio, NombreCentroAcopio, CASE Estado WHEN 1 THEN 'Activo' ELSE 'Inactivo' END Estado FROM centrosacopio WHERE NombreCentroAcopio <> '' ;";
...
$nombre_Tabla="";
do{
	$NombreUsuario = trim($row_rs_tipo_tabla['NombreCentroAcopio']);
	$archivo = $NombreUsuario.".php";
	$idTabla = $row_rs_tipo_tabla['IdCentroAcopio'];        
	$EstadoUsuario = trim($row_rs_tipo_tabla['Estado']);
?>
    <tr>
        <td>
           <a href="javascript:void(0);" onclick="cambiar('../forms/editarcentrosacopio.php?f=<?php echo $idTabla; ?>')" class="nav nav-tabs nav-stacked" data-toggle="modal" data-target="#defaultModalEditar" style="text-decoration:none;"><?php echo $NombreUsuario; ?></a>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content" >
                        ...
                        <div class="modal-body">
                            <object type="text/html" data="../forms/editartabla.php" id="carga" class="modalobj" style="height:295px !important;"></object>                           
                        </div>
            ...
            <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content" >
                        ...
                        <div class="modal-body">                         
                            <object type="text/html" data="../forms/form-validationBase<?php echo $nombre_lnk ;?>.php" id="crear" style="height:290px;"></object>
                        </div>
                        <div class="modal-footer">
