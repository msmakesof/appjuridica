...
$soportecURL = "S";
$url         = urlServicios."consultadetalle/consultadetalle_juz_tipojuzgado.php?IdMostrar=0";
$existe      = "";
$usulocal    = "";
$siguex      = "";
...
if( $mtipojuzgado['estado'] < 2)
{
    $nombre_Tabla="";
    for($i=0; $i<count($mtipojuzgado['juz_tipojuzgado']); $i++)
    {
        $NombreTabla = trim($mtipojuzgado['juz_tipojuzgado'][$i]['TJU_Nombre']);		
        $archivo = $NombreTabla.".php";
        $idTabla = $mtipojuzgado['juz_tipojuzgado'][$i]['TJU_IdTipoJuzgado'];
        $TJU_Codigo = $mtipojuzgado['juz_tipojuzgado'][$i]['TJU_Codigo'];
        $estadoTabla = trim($mtipojuzgado['juz_tipojuzgado'][$i]['EstadoTabla']);
    ?>
        <tr>
            <td>
