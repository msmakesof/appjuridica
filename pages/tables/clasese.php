...
<body class="theme-red">
                   ...
                   <!--  <li>
                    ...
                    <li class="active">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                                <a href="clasesn.php" class="menu-toggle">
    ...
    <div class="body">
        <div class="container-fluid" id="zonaalumno">
        <?php 
        //echo $idestudiante; 
        echo "<object type='text/html' data='clasealumno.php?id=$idestudiante' id='carga' style='height: 780px; width: 100%; margin: 2px;'></object>;"
        ?>            
        </div>
    </div>    
    </section>
    ...
    { 
       ...
       /*
        setInterval(function() { // Do this
                $('#zonaalumno').load("clasealumno.php?id=<?php echo $idestudiante; ?>");
          }, 5000); // Every one second
        */  
