...
$query_rs_usuario = "SELECT IdProfesor FROM profesores WHERE Estado_PRO = 1 AND Email_PRO = '$coo_User' ;" ;
...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT profesores.IdProfesor, concat_WS(' ', profesores.Nombres_PRO, profesores.Apellido1_PRO) as NombreProfesor, sucursal.NombreSucursal, nivel.NombreNivel, materia.NombreMateria, salon.NombreSalon, 
...
WHERE profesores.IdProfesor = $id AND profesores.Estado_PRO = 1 
           ...
           <div class="col-sm-10" id="zonahorario">
              ...
              <?php      
                ...
                do{
                    ...
                    $Nombre_Horario = trim($row_rs_tipo_tabla['IdEvento']).' - '.trim($row_rs_tipo_tabla['NombreHorario']);
...
<?php                          
              ...
              <?php    
                ...
                {
                  echo "<div style='cleear:both;font-size:14; background-color:red; color:white; text-align:center;-moz-border-radius: 15px;border-radius: 15px;'>No hay información Registrada.</div>";
                }
              ?>  
           </div>
        </div>  
