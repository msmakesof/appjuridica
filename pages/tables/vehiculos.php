...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT IdVehiculo, Placa, vehiculos.IdTransportador, concat_WS('',NombreTransportador, ApellidosTransportador) as NombreTransportador, vehiculos.IdConductor, conductores.Nombres AS NombreConductor, Modelo, EstadoVehiculo, NombreActivo FROM vehiculos JOIN transportadores ON transportadores.IdTransportador = vehiculos.IdTransportador JOIN conductores ON conductores.IdConductor = vehiculos.IdConductor JOIN EstadoActivo ON IdEstadoActivo = vehiculos.EstadoVehiculo ORDER BY Placa ;";
...
$nombre_Tabla="";
do{
	$NombreUsuario = trim($row_rs_tipo_tabla['Placa']);
	$archivo = $NombreUsuario.".php";
	$idTabla = $row_rs_tipo_tabla['IdVehiculo'];
    $NombreTransportador = $row_rs_tipo_tabla['NombreTransportador'];    
    $NombreConductor = trim($row_rs_tipo_tabla['NombreConductor']);
    $Modelo = trim($row_rs_tipo_tabla['Modelo']);
	$EstadoUsuario = trim($row_rs_tipo_tabla['NombreActivo']);
?>
    <tr>
        <td>
        ...
        <td><?php echo $NombreTransportador; ?></td>
