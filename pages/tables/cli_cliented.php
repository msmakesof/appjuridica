        ...
        <div class="container-fluid">
            <div class="block-header">
                <h2>
					...
					?>
                    INFORMACION DE: <?php echo "DEMANDADO"; echo $texto; // strtoupper($nombre_lnk) ?>
...
$url  = urlServicios."consultadetalle/consultadetalle_Cliente.php?IdMostrar=0&p2=$sesionUsuario&p3=". $condi . "&p4=2";
$existe      = "";
$usulocal    = "";
$siguex      = "";
...
?>
    ...
    $(document).ready(function () {	 
		...
		$("#nuevo").on("click", function(){        
			window.location = 'cli_clienteformad.php';
		});
    });

	function editar(id) 
	{    	
		$.post('../forms/cli_clienteeditad.php', { 'id': id }, function (result) {
