...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT NombreNivel, IdNivel, Nombre_Estado FROM nivel JOIN gen_estado ON gen_estado.Id_Estado = nivel.Estado ORDER BY NombreNivel;";
...
$nombre_Tabla="";
do{
	$Nombre = $row_rs_tipo_tabla['NombreNivel'];    
	$archivo = $Nombre.".php";
	$idTabla = $row_rs_tipo_tabla['IdNivel'];    
