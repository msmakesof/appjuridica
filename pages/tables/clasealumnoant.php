  ...
  <div class="modal-body">
    <form action="" method="post" id="form1">
      <!-- <label for="tipo">Curso</label> -->
        ...
        <div class="row">
          <div class="col-sm-10"><h2>Programaciones Anteriores Asignadas a usted.</h2></div>
        </div>
