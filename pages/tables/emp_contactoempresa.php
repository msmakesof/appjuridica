                        ...
                        <div class="body table-responsive" id="zonaquery">
							<table class="table table-bordered table-striped table-hover dataTable js-exportable" id="grid">
                                ...
                                <tbody>
									...
									require_once('../../Connections/DataConex.php');
									$soportecURL = "S";
									$url         = urlServicios."consultadetalle/consultadetalle_ContactoEmpresa.php?IdMostrar=0&par2=$pie";
									$existe      = "";
									$usulocal    = "";
									$siguex      = "";
									//echo("<script>console.log('PHP: contacto Empresa emp_x....".$url."');</script>");
