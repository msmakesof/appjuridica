...
$soportecURL = "S";
$url         = urlServicios."consultadetalle/consultadetalle_gen_grupo.php?IdMostrar=0";
$existe      = "";
$usulocal    = "";
$siguex      = "";
...
if( $mgrupo['estado'] < 2)
{
    ...
    {
        $NombreTabla = trim($mgrupo['gen_grupo'][$i]['GRU_Nombre']);        
        $archivo = $NombreTabla.".php";
        $idTabla = $mgrupo['gen_grupo'][$i]['GRU_IdGrupo'];
        $estadoTabla = trim($mgrupo['gen_grupo'][$i]['EstadoTabla']);
    ?>
        <tr>
            <td>
