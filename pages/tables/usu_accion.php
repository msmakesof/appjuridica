...
$soportecURL = "S";
$url         = urlServicios."consultadetalle/consultadetalle_usu_accion.php?IdMostrar=0";
$existe      = "";
$usulocal    = "";
$siguex      = "";
...
if(function_exists('curl_init')) // Comprobamos si hay soporte para cURL
{
    ...
    $maccion =  preg_replace('/[\x00-\x1F\x80-\xFF]/', '', $resultado);    
    $maccion = json_decode($maccion, true);
    //echo("<script>console.log('PHP: ".print_r($maccion)."');</script>");
    //echo("<script>console.log('PHP: ".count($m['usu_accion'])."');</script>");
...
if($soportecURL == "N")
{
    ...
    $maccion = json_decode($resultado, true);	        
} 

if( $maccion['estado'] < 2)
{
    $nombre_Tabla="";
    for($i=0; $i<count($maccion['usu_accion']); $i++)
    {
        $NombreTabla = trim($maccion['usu_accion'][$i]['ACC_Nombre']);        
        $archivo = $NombreTabla.".php";
        $idTabla = $maccion['usu_accion'][$i]['ACC_IdAccion'];
        $estadoTabla = trim($maccion['usu_accion'][$i]['EstadoTabla']);
    ?>
        <tr>
            <td>
            ...
            <td><?php echo $estadoTabla; echo ' - '.$idTabla; ?></td>               
        </tr>
    <?php                          
    }
}
...
<script type="text/javascript">
 $(document).ready(function () {	 
	$("#cerrarModal").click(function(){
	 	 window.location="usu_<?php echo $nombre_lnk ;?>.php";
	});
