...
$soportecURL = "S";
$url         = urlServicios."consultadetalle/consultadetalle_usu_tipousuario.php?IdMostrar=0";
$existe      = "";
$usulocal    = "";
$siguex      = "";
...
if( $mtipousuario['estado'] < 2)
{
    $nombre_Tabla="";
    for($i=0; $i<count($mtipousuario['usu_tipousuario']); $i++)
    {
        $NombreTabla = trim($mtipousuario['usu_tipousuario'][$i]['TUS_Nombre']);        
        $archivo = $NombreTabla.".php";
        $idTabla = $mtipousuario['usu_tipousuario'][$i]['TUS_ID_TipoUsuario'];
        $estadoTabla = trim($mtipousuario['usu_tipousuario'][$i]['EstadoTabla']);
    ?>
        <tr>
            <td>
