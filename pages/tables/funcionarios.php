...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT concat_WS(' ',NombresFuncionario, ApellidosFuncionario) AS NombreFuncionario, IdFuncionario, EmailFuncionario, NombreCentroAcopio, EstadoFuncionario FROM funcionario LEFT JOIN centrosacopio ON centrosacopio.IdCentroAcopio = funcionario.IdCentroAcopio  ORDER BY NombreFuncionario ;";
...
$nombre_Tabla="";
do{
	$NombreUsuario = trim($row_rs_tipo_tabla['NombreFuncionario']);
	$archivo = $NombreUsuario.".php";
	$idTabla = $row_rs_tipo_tabla['IdFuncionario'];    
    $Email = trim($row_rs_tipo_tabla['EmailFuncionario']);
    $NombreSucursal = trim($row_rs_tipo_tabla['NombreCentroAcopio']);
	$EstadoUsuario = trim($row_rs_tipo_tabla['EstadoFuncionario']);
?>
    <tr>
        <td>
           <a href="javascript:void(0);" onclick="cambiar('../forms/editarfuncionario.php?f=<?php echo $idTabla; ?>')" class="nav nav-tabs nav-stacked" data-toggle="modal" data-target="#defaultModalEditar" style="text-decoration:none;"><?php echo $NombreUsuario; ?></a>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content" >
                        ...
                        <div class="modal-body">
                            <object type="text/html" data="../forms/editartabla.php" id="carga" class="modalobj" style="height:650px;"></object>                           
                        </div>
            ...
            <div class="modal fade" id="defaultModal" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content" >
                        ...
                        <div class="modal-body">                         
                            <object type="text/html" data="../forms/form-validationBase<?php echo $nombre_lnk ;?>.php" id="crear" style="height:650px;"></object>
                        </div>
                        <div class="modal-footer">
