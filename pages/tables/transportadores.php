...
mysqli_select_db($cnn_kn, $database_cnn_kn);
$query_rs_tipo_tabla = "SELECT concat_WS(' ',NombreTransportador, ApellidosTransportador) AS NombreTransportador, IdTransportador, NitTransportador, DireccionTransportador, TelefonoTransportador, CelularTransportador, EmailTransportador, NombreCentroAcopio, EstadoTransportador FROM transportadores LEFT JOIN centrosacopio ON centrosacopio.IdCentroAcopio = transportadores.IdCentroAcopio  ORDER BY NombreTransportador ;";
...
$nombre_Tabla="";
do{
	$NombreUsuario = trim($row_rs_tipo_tabla['NombreTransportador']);
	$archivo = $NombreUsuario.".php";
	$idTabla = $row_rs_tipo_tabla['IdTransportador'];
    $nit = $row_rs_tipo_tabla['NitTransportador'];    
    $Email = trim($row_rs_tipo_tabla['EmailTransportador']);
    $NombreSucursal = trim($row_rs_tipo_tabla['NombreCentroAcopio']);
	$EstadoUsuario = trim($row_rs_tipo_tabla['EstadoTransportador']);
?>
    <tr>
        <td>
