...
$query_rs_usuario = "SELECT CONCAT_WS(' ',Nombres_EST,Apellido1_EST,Apellido2_EST) Nombre, Email_EST FROM estudiante WHERE Estado_EST = 1 AND Email_EST = '$usuario' AND  Clave_EST = '$clave';" ;
...
<body class="theme-red">
    ...
    <div class="body">
        <div class="container-fluid">
            <object type="text/html" data="../../Calendarioe/" id="carga" style="height: 780px; width: 100%; margin: 2px;"></object>           
        </div>
    </div>    
    </section>
