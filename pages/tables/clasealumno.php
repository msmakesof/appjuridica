...
JOIN jqcalendar ON jqcalendar.IdClase = clases.IdClase AND DATE(jqcalendar.StartTime) = clases.desde
WHERE clases.Estado = 1 AND MONTH(clases.desde) = MONTH(NOW());";
    ...
    $(document).ready(function () {  
        ...
        //$("input[type=checkbox]:checked").each(function() {
          ...
          else
          {
           ...
           $.ajax({
                ...
                //GET method is used
                type: "POST",
                data: "id="+tipoid+"&idclase="+idclase+"&estud=<?php echo $id; ?>",               
                beforeSend: function() {
                    // setting a timeout
                    swal({
      ...
      $("#grabar").on('click', function(){
          ...
          $.ajax({
                ...
                //GET method is used
                type: "POST",
                data: "id=g&idclase=<?php echo $idclase;?>&estud=<?php echo $id; ?>",
                beforeSend: function() {
                    // setting a timeout
                    swal({
                        title: "Actualizando información...",
      ...
      $("#cancelar").on('click', function(){ 
        ...
        else
        {
            ...
            $.ajax({
                  ...
                  //GET method is used
                  type: "POST",
                  data: "id=c&idclase=<?php echo $idclase;?>&estud=<?php echo $id; ?>",
                  beforeSend: function() {
                      // setting a timeout
                      swal({
                          title: "Actualizando información...",
           ...
           <div class="col-xs-12" id="zonahorario">
              ...
              <?php      
                ...
                do{
                    ...
                    $idnivelasignado = $row_rs_tipo_tabla['Nivel']; 
