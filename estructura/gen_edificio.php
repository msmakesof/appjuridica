...
class GEN_EDIFICIO
{
    ...
    {
        $consulta = "SELECT ".$GLOBALS['Llave'].", EDI_Nombre, EDI_Direccion, ".
            " CASE EDI_Estado WHEN 1 THEN 'Activo' ELSE 'Inactivo' END EstadoTabla ".
            " FROM ".$GLOBALS['TABLA']." ORDER BY EDI_Nombre; ";
        try {
            // Preparar sentencia
    ...
    {
        $consulta = "SELECT count(". $GLOBALS['Llave']. ") existe, EDI_Nombre FROM ".$GLOBALS['TABLA'].
        " WHERE EDI_Nombre = ? ; ";
