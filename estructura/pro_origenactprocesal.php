...
$TABLA ="pro_origenactprocesal";
$Llave ="OAP_IdOrigen";
class PRO_ORIGENACTPROCESAL
{
    ...
    {
        $consulta = "SELECT ".$GLOBALS['Llave'].", OAP_Nombre,  
            CASE OAP_Estado WHEN 1 THEN 'Activo' ELSE 'Inactivo' END EstadoTabla
            FROM ".$GLOBALS['TABLA']." ORDER BY OAP_Nombre; ";
        try {
            // Preparar sentencia
    ...
    public static function getById($IdTabla)
    {
        ...
        $consulta = "SELECT ".$GLOBALS['Llave'].",
                            ...
                            OAP_Estado
                            FROM ".$GLOBALS['TABLA'].
                            " WHERE ".$GLOBALS['Llave']." = ? ORDER BY OAP_Nombre; ";
    ...
    public static function getByIdEstado($IdEstadoTabla)
    {
        ...
        $consulta = "SELECT ".$GLOBALS['Llave'].", OAP_Nombre, OAP_Estado ".
                    " FROM ". $GLOBALS['TABLA'].
                    " WHERE OAP_Estado = ? ORDER BY OAP_Nombre; ";
    ...
    {
        // Consulta de PRO_UBICACION
        $consulta = "SELECT Count(".$GLOBALS['Llave'].") AS TotalTablas, OAP_Nombre, OAP_Estado ".
                    " FROM ". $GLOBALS['TABLA'].
                    " WHERE ".$GLOBALS['Llave']."  = ? ;";
    ...
    public static function existetabla($Nombre, $par2)
    {
        ...
        " WHERE OAP_Nombre = ? AND ". $GLOBALS['Llave']. " <> ?; ";
