...
$TABLA ="gen_tipopersona";
$Llave ="TPE_IdTipoPersona";
class GEN_TIPOPERSONA
{
    ...
    {
        $consulta = "SELECT ".$GLOBALS['Llave'].", TPE_Nombre,  
            CASE TPE_Estado WHEN 1 THEN 'Activo' ELSE 'Inactivo' END EstadoTabla
            FROM ".$GLOBALS['TABLA']." ORDER BY TPE_Nombre; ";
        try {
            // Preparar sentencia
