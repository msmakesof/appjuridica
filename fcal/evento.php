    ...
    <section class="content">
        <div class="container-fluid">            
            ...
            <div class="row clearfix" style="">                                
                <!-- 1 -->
                <div class="content" style="background: white;width:100%; margin-top: -104px !important">

                    <!-- <div class="row" >                        
                        <div id="xcalendar" style="width: 100%;">
						-->
							
						<div class="modal-dialog" id="modalAgenda">
                        <div class="flex-container modal-content" style="height:auto !important">
                            ...
                            <div class="modal-body" style="height:auto !important">
                                ...
                                <div class="form-group">
                                    <div class="row" style="margin-top:20px">
                                        <div class="col-lg-12 col-md-12 col-sm-12">
                                            ...
                                            <div class="form-line" style="width: 98%">
                                            <input type="text" required autocomplete="off" name="title" class="form-control" id="title" placeholder="Digite un Asunto">
                                            </div>
                                        </div>
                                    </div>	
                                </div>
								...
								<div class="cmodal-footer"  style="height:40px;">
                                    <div class="row">
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
											<button type="button" class="btn btn-success" id="agregar" onclick="myFunction()">
                                                <i class="fa fa-check"></i> Grabar
                                            </button>	
                                            <button type="button" class="btn btn-danger" data-dismiss="modal" id="salir">
                                    ...
                                    $(document).ready(function(){ 
										...
										$("#responsable").on('change', function(){
											...
											$.ajax({
												...
												data: {"id": idresponsable, "tu": tipousuario },												
												contentType: "application/json; charset=utf-8",												
												dataType: 'json',												
												success: function( mdata, textStatus, jQxhr ){													
													var selectedOption = '0'
													var g = mdata;
													var newOptions = g; 
													var select = $('#proceso');
                                ...
                                function myFunction() {    
									...
									if(fromx == "" || to =="" || proceso == "" || responsable == "" || tipousuario == "" || tipo == "" || title == "" || body == "")
									{
										$("#modalAgenda").hide();										
										$("#modalAgendaOk").hide();
										$("#modalErr").show();
									...
									{                                    
										$.ajax({
											...
											type: 'POST',                            
											dataType: 'html',                                        
											data: {"from": from, "to": to, "proceso": proceso, "tipousuario": tipousuario ,"responsable" : responsable, "tipo": tipo, "title": title, "body": body},
