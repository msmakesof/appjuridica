					...
					<div id="loginbox" style="margin-top:50px;" class="mainbox col-md-12 col-md-offset-0 col-sm-10 col-sm-offset-2">                    
						<div class="panel panel-info" >
							<div class="panel-heading">
								...
								<div style="float:right; font-size: 80%; position: relative; top:-10px"><a href="index.php">Volver a Iniciar Sesi&oacute;n</a></div>
							</div>     
					...
					if( token != "" && pass1 != "" && pass2 != "" )
					{
						if ( pass1 === pass2 ) {
							if( enviar )
							{
								alert(enviar);
								$.ajax({
									data: { "mail": email, "clave1": pass1, "clave2": pass2, "codigo": token },
									type: 'POST',
									dataType: "html",
				...
				<div class="ccontainer" style="width:100% !important;">    
					<div id="loginbox" style="margin-top:50px;" class="mainbox col-md-12 col-md-offset-0 col-sm-10 col-sm-offset-2">                    
						...
						<div style="padding-top:15px" class="panel-body">
							<div class = "alert alert-danger">No es posible realizar esta acción, favor envie un email a: soporte@litigantes.com</div>
						</div>
