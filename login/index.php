...
<html>
	...
	<body>
		...
		<div class="container">
			<div id="loginbox" style="margin-top:50px;" class="mainbox col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="panel panel-info" >				
					
					<div style="padding-top:30px" class="panel-body" >
						<div class="col-sm-6 controls">
							<img src="../images/3.jpg" width="180" height="130">
						</div>
						<div class="col-sm-6 controls">
							<h3><label style="font-size:38px ; font-family: Verdana">LITIGANTES.</label></h3>
						</div>
					</div>
					...
					<div id="recpas">
						...
						<div style="padding-top:30px" class="panel-body" >
							...
							<div style="display:none" id="login-alert" class="alert alert-danger col-lg-12 col-md-12 col-sm-12 col-xs-12"></div>
							
							<form id="loginform" class="form-horizontal" role="form" action="" method="POST" autocomplete="off">
								
								<div style="margin-bottom: 25px" class="input-group">
									<span class="input-group-addon"><i class="glyphicon glyphicon-envelope"></i></span>
									<input id="email" type="email" class="form-control form-control" name="email" placeholder="Digite su Correo Electrónico" required>                                        									
								</div>
								<div style="margin-top:1px; margin-left:10;" class="form-group" id="msj">
									<div class="col-sm-10 controls"></div>
								</div>
								
								<div style="margin-top:10px" class="form-group form-group-lg">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 controls">									
										...
										<div class="col-sm-10 controls" style="font-size:10; color:red;"> Marque esta casilla s&oacute;lo si tiene el c&oacute;digo asignado.</div>
									</div>
								...
								<div style="margin-top:10px" class="form-group">
									<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 controls">
										<button id="btn-login" type="button" class="btn btn-success btn-lg">Enviar</button>									
									</div>
								</div>
