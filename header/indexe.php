...
{    
    ...
    $query_rs_usuario = "SELECT CONCAT_WS(' ',Nombres_EST,Apellido1_EST,Apellido2_EST) Nombre, Email_EST, IdEstudiante FROM estudiante WHERE Estado_EST = 1 AND Email_EST = '$usuario' ;" ;
    ...
    //{
        ...
        //{
            ...
            $email = $row_rs_usuario['Email_EST'];   
            $idestudiante = $row_rs_usuario['IdEstudiante'];
            //echo $nombre;
        //}
    //}
    ...
    mysqli_select_db($cnn_kn, $database_cnn_kn);
    $query_rs_nivelxest = "SELECT count(IdEstudiante) as cantnivel FROM nivelasignado WHERE IdEstudiante = $idestudiante 
    AND Estado = 1;";
    ...
    // mysqli_select_db($cnn_kn, $database_cnn_kn);
    // $query_rs_tipo_tabla = "SELECT count(IdEstudiante) as cantclases FROM clasexestudiante WHERE IdEstudiante = $idestudiante 
    // AND IdClase = $idClase AND Estado = 'A';";
    ...
    mysqli_select_db($cnn_kn, $database_cnn_kn);    
	$query_rs_ctacupos = "SELECT count(IdClasexEstudiante) Cantidad FROM clasexestudiante WHERE Estado = 'A' AND IdEstudiante = $idestudiante;";    
    ...
    mysqli_select_db($cnn_kn, $database_cnn_kn);
    $query_rs_tipo_ntabla = "SELECT estudiante.IdEstudiante, clasexestudiante.* , sucursal.NombreSucursal, nivel.NombreNivel, materia.NombreMateria, salon.NombreSalon, CONCAT_WS(' - ', horario.Inicio,horario.final) as NombreHorario, concat_WS(' ', profesores.Nombres_PRO, profesores.Apellido1_PRO) as NombreProfesor, clases.IdClase, clases.desde, clases.hasta
    FROM estudiante 
    ...
    -- JOIN clases ON clases.Nivel = nivelasignado.IdNivel AND '$fechaMes' BETWEEN clases.desde AND clases.hasta
    ...
    $NombreProfesor = trim(strtoupper($row_rs_tipo_ntabla['NombreProfesor']));
    $NombreNivel = trim(strtoupper($row_rs_tipo_ntabla['NombreNivel']));
    //echo "<br><br><br><br><br><br>$query_rs_tipo_ntabla";
}
else
{
    $usuario ="";
                   ...
                   <!--  <li>
                    ...
                    <li class="active">
                        ...
                        <ul class="ml-menu">
                            ...
                            <li>
                               <a href="../pages/tables/clasesn.php" class="menu-toggle">
                                <!--  <a href="../actualizacion.html" class="menu-toggle"> -->
            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">NIVEL ASIGNADO:</div>
                            <div class="text" data-speed="1000" data-fresh-interval="20"><?php echo $NombreNivel; ?></div>
                            <div class="number count-to" data-from="" data-to=""  data-speed="15" data-fresh-interval="20">
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">CLASES RESERVADAS:</div>
                            <div class="text" data-speed="1000" data-fresh-interval="20"><?php echo $TotalProgramadasAlumno; ?></div>
                            <div class="number count-to" data-from="" data-to="" data-speed="1000" data-fresh-interval="20"></div>
                        </div>
                    </div>
                </div>
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            ...
                            <div class="text" data-speed="1000" data-fresh-interval="20"><?php echo $NombreProfesor; ?></div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-orange hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">TOTAL CLASES TOMADAS</div>
                ...
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    <div class="card">
                        <div class="header bg-pink">
                            <h2>
                                <div class="icon"><i class="material-icons">flag</i><small>NIVELES / TOPICS</small>
                            </h2>                            
                        </div>
                        <div class="body">
                            <?php                             
                            ...
                            <div class="table-responsive">
                                <table class="table table-hover dashboard-task-infos">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td>No olvides asistir puntualmente a clase, para poder cumplir con todos los objetivos del nivel y tener tiempo para desarrollar dinámicas y actividades adicionales. Recuerda que llegar 20 minutos tarde todos los días, equivale a perder 6 horas de clase del nivel. 
                                            </td>
                                         ...
                                         <tr>
                                            <td>2</td>
                                            <td>Para cancelar la clase reservada lo puedes hacer en nuestra web o telefónicamente bajo los siguientes parámetros: La clase se considera cancelada cuando el estudiante informa:
                                            	<ul>
                                            	<li> Antes de las 5:00 pm  si la clase es en la mañana.</li>
