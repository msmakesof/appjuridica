...
echo "sesion....".$_SESSION['Usuario']."<br>";
            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Pedidos sin Validar: <?php echo $nombremes. ' de '.$yy ;?> </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-cyan hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Pedidos en Alistamiento</div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-light-green hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Pedidos en Reparto </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-orange hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Pedidos No Entregados</div>
                    ...
                    <div class="card">                        
                        <div class="body bg-pink">
                            ...
                            <div class="m-b--35 font-bold">
                                <div class="icon">
                                <i class="material-icons">av_timer</i> Pedidos Entregados
                                </div>                                
                            </div>                            
                            <ul class="dashboard-stat-list">
                                ...
                                <li>
                                    HOY
                                    <span class="pull-right"><b>232 Pedidos.</b> <small></small></span>
                                </li>
                                <li>
                                    AYER
                                    <span class="pull-right"><b>899 Pedidos.</b> <small></small></span>
                                </li>
                                <li>
                                    SEMANA PASADA
                                    <span class="pull-right"><b>1200 Pedidos.</b> <small></small></span>
                                </li>
                            </ul>
                        </div>
                    </div>
