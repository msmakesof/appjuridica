            ...
            function Edit(data)
            {
               var eurl="edit.php?id={0}&start={2}&end={3}&isallday={4}&title={1}";   
                if(data)
                {
                    ...
                    OpenModelWindow(url,{ width: 680, height: 690, caption:"Administrador de Planificación CONINGLES.",onclose:function(){
...
<body>
    <div>
	<img src="../../images/logo.png" width="300px" height="100px" />
      <div id="calhead" style="padding-left:1px;padding-right:1px;">          
            <div class="cHead"><div class="ftitle">Cronograma de Actividades - ADMINISTRADOR - CONINGLES.</div>
...
<div id="p8" style="float:right;color:#FFFF00; background:#369; width: 200px;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;■ Observaciones Realizadas</div>
            ...
            <div id="showdaybtn" class="fbutton">
                <div><a href="../../pages/tables/clases.php"><span title='Cerrar' class="showcloseview">Cerrar</span></a></div>
            </div>
