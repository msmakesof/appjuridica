...
function getCalendarByRange($id){
  try{
    ...
    //$sql = "select * from jqcalendar where id = " . $id;	
     $sql = "select jqcalendar.*, tipo_auditoria.nom_ti_audit from jqcalendar join tipo_auditoria on tipo_auditoria.cod_ti_audit = jqcalendar.tipo_auditoria join auditoria on auditoria.id = jqcalendar.auditoria join listachqxtipoaudit on listachqxtipoaudit.id_listacheq = jqcalendar.listachq where jqcalendar.id = " . $id;
...
<!--        <a id="Deletebtn" class="imgbtn" href="javascript:void(0);">                    
          <span class="Delete" title="Borrar la novedad.">Borrar(<u>B</u>)
          </span>                
        </a>-->             
        <?php } ?>            
      ...
      <div class="infocontainer">            
        <form action="php/datafeed.php?method=adddetails<?php echo isset($event)?"&id=".$event->Id:""; ?>" class="fform" id="fmEdit" method="post">                 
          ...
          <label>                    
            ...
            <input MaxLength="200" id="tiponovedad" name="tiponovedad" style="width:95%;" type="text" value="<?php //echo isset($event)?$event->nombre:""; ?>" />                 
          </label>--> 
