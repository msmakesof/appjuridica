...
<head id="Head1">
    ...
    <script type="text/javascript">
        $(document).ready(function() {     
           //var view="week"; 
					 var view="month"; 
					 	var DATA_FEED_URL = "php/datafeedgea.php";
               ...
               var eurl="edit.php?id={0}&start={2}&end={3}&isallday={4}&title={1}";   
                if(data)
                {
                    var url = StrFormat(eurl,data);
										var alto = 0;
										<?php if($isadmin != 'Y') { ?> alto = 690; <?php } else {?> alto = 870; <?php }?>
                    OpenModelWindow(url,{ width: 680, height: alto, caption:"Administrador de Planificación InterRapidísimo.",onclose:function(){
