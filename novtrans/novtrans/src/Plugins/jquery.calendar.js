/**
  ...
  */
; (function($) {
    var __WDAY = new Array(i18n.xgcalendar.dateformat.dom, i18n.xgcalendar.dateformat.lun, i18n.xgcalendar.dateformat.mar, i18n.xgcalendar.dateformat.mie, i18n.xgcalendar.dateformat.jue, i18n.xgcalendar.dateformat.vie, i18n.xgcalendar.dateformat.sab);
    var __MonthName = new Array(i18n.xgcalendar.dateformat.ene, i18n.xgcalendar.dateformat.feb, i18n.xgcalendar.dateformat.mar, i18n.xgcalendar.dateformat.abr, i18n.xgcalendar.dateformat.may, i18n.xgcalendar.dateformat.jun, i18n.xgcalendar.dateformat.jul, i18n.xgcalendar.dateformat.ago, i18n.xgcalendar.dateformat.sep, i18n.xgcalendar.dateformat.oct, i18n.xgcalendar.dateformat.nov, i18n.xgcalendar.dateformat.dic);
    ...
    $.fn.bcalendar = function(option) {
                ...
                for (var h = 0; h < l; ) {
                    ...
                    if (e) { 
                        ...
                        if (!bs && j == (sc - 1) && z[h] < y[h]) {
                            el++;
                            $.extend(tempdata, { "axis": h, ch: "more", "abbr": dateFormat.call(cday[h], i18n.xgcalendar.dateformat.fulldayvalue), html: i18n.xgcalendar.others + (y[h] - z[h]) + i18n.xgcalendar.item, click: "javascript:alert('Más Actividades');" });
            ...
            if (data != null) {
                if (option.quickDeleteUrl != "" && data[8] == 1 && option.readonly != true) {
                    var csbuddle = '<div id="bbit-cs-buddle" style="z-index: 180; width: 400px;visibility:hidden;" class="bubble"><table class="bubble-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="bubble-cell-side"><div id="tl1" class="bubble-corner"><div class="bubble-sprite bubble-tl"></div></div><td class="bubble-cell-main"><div class="bubble-top"></div><td class="bubble-cell-side"><div id="tr1" class="bubble-corner"><div class="bubble-sprite bubble-tr"></div></div>  <tr><td class="bubble-mid" colSpan="3"><div style="overflow: hidden" id="bubbleContent1"><div><div></div><div class="cb-root"><table class="cb-table" cellSpacing="0" cellPadding="0"><tbody><tr><td class="cb-value"><div class="textbox-fill-wrapper"><div class="textbox-fill-mid"><div id="bbit-cs-what" title="'
                    	+ i18n.xgcalendar.click_to_detail + '" class="textbox-fill-div lk" style="cursor:default;"></div></div></div></td></tr><tr><td class=cb-value><div id="bbit-cs-buddle-timeshow"></div></td></tr></tbody></table><div class="bbit-cs-split"><input id="bbit-cs-id" type="hidden" value=""/>[ <span id="bbit-cs-delete" class="lk">'
                    ...
                    if (bud.length == 0) {
                        ...
                        // mks 20171015  se deja en comentario para no mostra ventana emergente js
                        $("#xbbit-cs-what").click(function(e) {
                    ...
                    //$("#bbit-cs-what").html(data[1]);  // mks 20171015 se deja en comentario 
                    $("#bbit-cs-what").html("");
        ...
        function moreshow(mv) {
            ...
            var day = new Date(arrdays[0], parseInt(arrdays[1] - 1), arrdays[2]);   // original mks
