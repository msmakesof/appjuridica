...
function listCalendarByRange($sd, $ed, $parpr, $parvi){
  $ret = array();
  $ret['events'] = array();
  $ret["issort"] =true;
  ...
  $ret['error'] = null;
	...
	//$condi = " and Location ='GEH'";
	$condi = " and Location ='$parpr'";
...
function listCalendar($day, $type, $parpr, $parvi){
  ...
  //echo $st . "--" . $et;
  return listCalendarByRange($st, $et, $parpr, $parvi);
}
...
switch ($method) {
    case "add":
        ...
        break;
    case "list":
        $ret = listCalendar($_POST["showdate"], $_POST["viewtype"], $parpr ,$parvi );
        break;
    case "update":
