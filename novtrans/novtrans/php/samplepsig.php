...
else 
{
		  ...
		  $_SESSION['MM_adminss'] = $row_rs_privilegios["admin"];
			...
			$proceso_x = $abr2; //trim($row_rs_privilegios["racolp"]);
			echo $proceso_x;
			$xproceso_x = strtolower($proceso_x);
			
			//$proc ="php/datafeed2$xproceso_x.php";			
			//$proc ="php/datafeed2.php?idd=$xproceso_x";			
			$proc ="php/datafeedgea2.php?idd=$proceso_x";			
			...
			mysql_select_db($database_cnn_plan_mejora, $cnn_plan_mejora);
			$query_rs_proceso = "SELECT proceson FROM procesos WHERE abr2 = '$abr2'";
			$rs_proceso = mysql_query($query_rs_proceso, $cnn_plan_mejora) or die(mysql_error());
			$row_rs_proceso = mysql_fetch_assoc($rs_proceso);
			$totalRows_rs_proceso = mysql_num_rows($rs_proceso);	
			$proceson = trim($row_rs_proceso['proceson']);
...
<head id="Head1">
    ...
    <script type="text/javascript">
        $(document).ready(function() {     
           //var view="week"; 
					 var view="month"; 
					 	var DATA_FEED_URL = "php/datafeedgea2.php";
            ...
            var op = {
                ...
                autoload:true,               
								url: DATA_FEED_URL + "?method=list<?php echo $enviapar; ?>",
...
<body>
	...
	<img src="../../SINTER LOGIN/imagenes/header-sifi.jpg" width="100%" height="128" />
      <div id="calhead" style="padding-left:1px;padding-right:1px;">          
            <div class="cHead"><div class="ftitle">Cronograma de Actividades Proceso: <?php echo $proceso_x; ?> - <?php echo $proceson; ?> - <?php echo $nomproceso_x; ?> - INTERRAPIDISIMO.</div>
						<div class="ftitlemks">							
...
<div id="p8" style="float:none;color:#FFFF00;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;■ Observaciones Realizadas</div>
