    ...
    $.fn.bcalendar = function(option) {
        ...
        function quickadd(start, end, isallday, pos) {
            ...
            if (buddle.length == 0) {
                ...
                temparr.push(i18n.xgcalendar.example, '</div></td></tr></tbody></table><input id="bbit-cal-start" type="hidden"/><input id="bbit-cal-end" type="hidden"/><input id="bbit-cal-allday" type="hidden"/>');
                temparr.push(i18n.xgcalendar.create_event, '&nbsp; <SPAN id="bbit-cal-editLink" class="lk">');
        ...
        function ResizeView() {
            ...
            if (_viewType == "day" || _viewType == "week") {
                //if (_viewType == "dia" || _viewType == "semana") {
