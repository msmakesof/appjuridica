           ...
           var view="month";          
            ...
            function cal_beforerequest(type)
            {
                ...
                switch(type)
                {
                    ...
                    case 3:  
                    case 4:    
                        t="Requerimientos está siendo procesado ...";                                   
                        break;
                }
                $("#errorpannel").hide();
            ...
            // salir
             $("#salirbtn").click(function(e) {                
                window.location.href = "../header/index.php";     
            });
      ...
      <div id="calhead" style="padding-left:1px;padding-right:1px;">          
            ...
            <div id="caltoolbar" class="ctoolbar">
                <!-- <div id="faddbtn" class="fbutton">
                    <div>
                        <span title='Click para Crear Nueva Programación' class="addcal"> Nueva Programación </span>
                    </div>
                </div> -->
                ...
                <div id="salirbtn" class="fbutton">
                    <div>
                        <span title='Click para Salir' class="salircal"> Salir </span>
                    </div>
                </div>
