...
<head>
    ...
    <title>Bienvenido a | KN Administrador</title>
    <!-- Favicon-->
...
<!--
                            <li>
                                <a href="pages/tables/normal-tables.html">Aeropuertos</a>
                            </li>
                            <li>
                                <a href="pages/tables/jquery-datatable.html">Ciudades</a>
                            </li>
                            <li>
                                <a href="pages/tables/editable-table.html">Contenedores</a>
                            </li>
-->
                        </ul>
                    </li>
            ...
            <div class="row clearfix">
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-pink hover-expand-effect">
                        ...
                        <div class="content">
                            <div class="text">Exportaciones</div>
                    ...
                    <div class="card">
                        <div class="body bg-pink">
                            ...
                            <ul class="dashboard-stat-list">
                                <li>
                                    HOY
                                    <span class="pull-right"><b>Transp. Alianza 2</b> <small>Usos</small></span>
                                </li>
                                <li>
                                    AYER
                                    <span class="pull-right"><b>Metro Transp. 8</b> <small>Usos</small></span>
                                </li>
                                <li>
                                    SEMANA PASADA
                                    <span class="pull-right"><b>Alcance 1</b> <small>Usos</small></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-4">
                    <div class="card">
                        <div class="body bg-cyan">
                            <div class="m-b--35 font-bold">ULTIMOS PROCESOS</div>
                            <ul class="dashboard-stat-list">
                                <li>
                                    OTM´S
                                ...
                                <li>EXPORTACIONES</li>
                                <li>NACIONALIZACION DE CARGA</li>
                                <li>TRASPORTADORES</li>
                                <li>
                                    GESTION TIEMPOS
                                    <span class="pull-right">
                                        <i class="material-icons">trending_up</i>
